...
<div style="padding-top:1px">
	<div id="form1">
		<input id="appfuncgroup.acApplication.appid" name="appfuncgroup.acApplication.appid" class="nui-hidden" />
        <table style="width:100%;height:96%;table-layout:fixed;" class="nui-form-table" >
            <tr>
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "com.bos.utp.framework.FuncGroupManager.saveFuncGroup.biz.ext",
                type: 'POST',
                data: json,
                cache: false,
        ...
        function SetData(data) {
            ...
            data = nui.clone(data);
            document.getElementById("appfuncgroup.acApplication.appid").value = data.appid;
        }
    </script>
</body>
</html>