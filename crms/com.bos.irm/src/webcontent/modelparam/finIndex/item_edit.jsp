...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%--   --%><input type="hidden" name="tbIrmRatingFinIndex" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"tbIrmRatingFinIndex":
		{"indexId":
		"<%=request.getParameter("indexId") %>"}});
	$.ajax({
        url: "com.bos.irm.param.getTbIrmRatingFinIndex.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.param.updateTbIrmRatingFinIndex.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
