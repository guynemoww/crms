            	 ...
            	 menudata = [
		                         {id:"客户预警", text:"客户预警", //expanded:true, 
			                          children:[
				                                ...
				                                {id:"新增预警信号复核",text:"新增预警信号复核",url:"/ews/warnDetail/warnMgr/ews_warnInfo_add.jsp?bizId="+bizId+"&corpid="+party.partyId}
			                                    ]}
		                       ];  
            	}else{
                 menudata = [
		                         {id:"客户预警", text:"客户预警", //expanded:true, 
			                          children:[
				                                {id:"预警信号列表",text:"预警信号列表",url:"/ews/warnDetail/warnInfo/ews_warning_list.jsp?corpid="+party.partyId},
			                                    {id:"预警级别认定复核",text:"预警级别认定复核",url:"/ews/warnDetail/warnMgr/review/ews_warnLevel_hold.jsp?bizId="+bizId+"&partyId="+party.partyId}
			                                    ]}
		                       ]; 
