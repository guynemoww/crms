...
<div id='ht' class="nui-dynpanel"  columns="4" style="width:99.5%;">
	<!-- <label>入账账号：</label>
	<input id="conDetail.rzzh" name="conDetail.rzzh"  class="nui-textbox nui-form-input" required="true"/> -->
	<label>议付号：</label>
	<input id="conDetail.yfh" name="conDetail.yfh"  required="true" class="nui-textbox nui-form-input"/>
</div>
