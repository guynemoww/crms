...
<body>   
   <jsp:include flush="true" page="/grt/manage/manage_pages/grt_col_manage_Appindex.jsp"/>   
...
<div class="nui-toolbar" style="border-bottom:0;text-align:center;">
    ...
    <script type="text/javascript">
        ...
        {	
            ...
            var id = row.suretyId;
            var json = nui.encode({"tbGrtGuarantybasic":{"suretyId":id}});
                nui.ajax(
                {
                    url: "com.bos.grt.manage.TbGrtGuarantybasic.getTbGrtGuarantybasic.biz.ext",//上部分需要的逻辑流(返回对象tbGrtGuarantybasic)
	                type: 'POST',
	                data: json,
                    ...
                    success: function (text)
                    {
                        ...
                        formEdit.setData(o);
                        nui.get("item.guarantyId").setValue(text.tbGrtGuarantybasic.suretyId);
