...
<body>
	...
	<div  class="nui-dynpanel" columns="4">
		...
		<label id="subcontractAmtLab">质押合同金额：</label>
		...
		<label id="zgbjxeLab">质押最高本金限额：</label>
		...
		<label id="beginDateLab">质押额度起期：</label>
	    ...
	    <label id="endDateLab">质押额度止期：</label>
		...
		<label>几个工作日内交付质物：</label>
		<input name="subContract.jrncrbzj" id="subContract.jrncrbzj"required="true" class="nui-textbox nui-form-input"  vtype="int;maxLength:20;range:1,1000" />
...
<script type="text/javascript">
	...
	function selectChange(e){
		if(e.value=='1'){
			...
			nui.get("subContract.jrncrbzj").setRequired(true);//几日内交付质物
		}else{
			...
			//$("#zfwyjblLab").show();
			nui.get("subContract.jrncrbzj").setRequired(false);//几日内交付质物
		}
