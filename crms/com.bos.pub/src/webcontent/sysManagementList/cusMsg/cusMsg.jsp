...
<div id="datagrid1"    class="nui-datagrid" style="width:100%;height:auto;"  sortMode="client"
	    url="com.bos.pub.sysManagementList.getCusNameAndOrgn.biz.ext" dataField="cus"
	    ...
	    <div property="columns">
	        ...
	        <div field="certificateTypeCd" allowSort="true" width="" headerAlign="center" dictTypeId="CDKH0002">证件类型</div>
