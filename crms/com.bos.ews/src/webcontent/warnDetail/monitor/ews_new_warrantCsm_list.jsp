...
//给选中客户信息增加预警信号
	function view(){
		...
		//alert(row.partyId);
		var url=nui.context + "/ews/warnDetail/warnInfo/ews_warnInfo_monitor_add.jsp?corpid="+row.partyId+"&type=06&monitor=1&partyName="+row.partyName+"&partyNum="+row.partyNum;
