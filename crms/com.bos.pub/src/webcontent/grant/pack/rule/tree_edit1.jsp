...
<div id="treeDiv" style="position:absolute;left:105px;height:1000px;border-left:solid 1px;">
...
function dialog(dom, btns, p) {
	self.dialogdom=dom;
	$('<div style="height:100px;"><br/></div>').appendTo($(dom));
	$(dom).dialog($.extend({},{
		autoOpen: true, 
		draggable: true, 
		modal: true,
...
function menuNodeRule() {
	...
	var div=$('<div><span>规则/授权表内容</span>&nbsp;<br/></div>');
