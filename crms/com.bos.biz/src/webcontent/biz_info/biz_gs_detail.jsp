...
<script type="text/javascript">
	...
	function update(gr){
		...
		if (row) {
			...
			var ecifPartyNum = nui.get("tbBizApply.ecifPartyNum").getValue();
    		nui.open({
	            url: nui.context + "/com.bos.bizProductDetail.getProductDetail.flow?amountDetailId="+amountDetailId+"&productType="+row.productType+"&modelFlag=01&bizType="+bizType+"&proFlag="+proFlag+"&bizHappenType="+bizHappenType+"&partyId="+partyId+"&ecifPartyNum="+ecifPartyNum,
	            showMaxButton: true,
	            title: "业务品种明细信息",
	            width: 800,
	            height: 500,
	...
	function view(gr){
		...
		if (row) {
			...
			var partyId = nui.get("tbBizApply.partyId").getValue();
    		nui.open({
	            url: nui.context + "/com.bos.bizProductDetail.getProductDetail.flow?amountDetailId="+amountDetailId+"&productType="+row.productType
	            	 +"&modelFlag=01&bizType="+bizType+"&proFlag=0"+"&partyId="+partyId,
	            showMaxButton: true,
	            title: "业务品种明细信息",
	            width: 800,
	            height: 500,
