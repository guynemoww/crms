...
<script type="text/javascript">
   ...
   /*  if(proFlag == "1") {
	...
	if("1"==flag || "2"==flag){//小企业信贷中心日常检查
		menudata = [
			{id:"日常检查信息", text:"日常检查信息",
				children:[
					{id:"检查信息",text:"检查信息",url:"/aft/normalCheck/normalCheck_small_apply.jsp?normalCheckId="+normalCheckId}
				]
			},
	...
	if("3"==flag){//小企业信贷中心日常检查
		menudata = [
			{id:"日常检查信息", text:"日常检查信息",
				children:[
					{id:"检查信息",text:"检查信息",url:"/aft/normalCheck/normalCheck_small_view.jsp?normalCheckId="+normalCheckId}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
