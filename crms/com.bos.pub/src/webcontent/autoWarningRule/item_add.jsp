...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<label>预警信号代码：</label>
		<input name="tbRewAutoWarningRule.signalCode" required="false" class="nui-buttonEdit nui-form-input" allowInput="false" dictTypeId="XD_KH2D0098" onbuttonclick="selectSignal" vtype="maxLength:10" />
		<label>规则SQL语句：</label>
		<div colspan="3">
...
function save() {
	...
	$.ajax({
        url: "com.bos.pub.autoWarningRule.addTbRewAutoWarningRule.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
