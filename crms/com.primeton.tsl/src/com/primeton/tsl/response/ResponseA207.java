 ...
 */
public class ResponseA207 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6369841721970909071L;
	private String FIRST_NO_PSN;//起始笔数
	private String RESULT_SIZE_PSN;//查询笔数
	private String ALL_RESULT_SIZE_PSN;//总笔数
	...
	private String REL_CUST_NO;//关系人客户号
	private String REL_NAME;//关系人名称
	private String REL_CERT_TYPE;//关系人证件类型
	private String REL_CERT_NO;//关系人证件号码
	private String MAIN_INVST_TYPE;//出资方式/持股类型
	private String INVST_DESC;//出资方式说明
	private String OUGHT_INVST_SUM;//应投资金额
	private String ACTUL_INVST_SUM;//实际投资金额
	private String INVST_CURR;//投资币种
	private String HOLD_RATIO;//持股/投资比例
	private String INVST_DATE;//投资时间
	private String STOCK_CERT_NO;//股权证号
	...
	private String WORK_RESUME;//工作简历
	private String CREDIT_FINCIL_DESC;//资信情况
	private String IS_WORK_FLAG;//是否在单位任职
	private String PART_TIME_FLAG;//是否在其他工作单位兼职
	private String PART_TIME_DESC;//兼职单位名称
	...
	/**
	 * @return aLL_RESULT_SIZE_PSN
	 */
	public String getALL_RESULT_SIZE_PSN() {
		return ALL_RESULT_SIZE_PSN;
	}

	/**
	 * @param aLL_RESULT_SIZE_PSN 要设置的 aLL_RESULT_SIZE_PSN
	 */
	public void setALL_RESULT_SIZE_PSN(String aLL_RESULT_SIZE_PSN) {
		ALL_RESULT_SIZE_PSN = aLL_RESULT_SIZE_PSN;
	}
	...
	/**
	 * @return mAIN_INVST_TYPE
	 */
	public String getMAIN_INVST_TYPE() {
		return MAIN_INVST_TYPE;
	}

	/**
	 * @param mAIN_INVST_TYPE 要设置的 mAIN_INVST_TYPE
	 */
	public void setMAIN_INVST_TYPE(String mAIN_INVST_TYPE) {
		MAIN_INVST_TYPE = mAIN_INVST_TYPE;
	}

	/**
	 * @return iNVST_DESC
	 */
	public String getINVST_DESC() {
		return INVST_DESC;
	}

	/**
	 * @param iNVST_DESC 要设置的 iNVST_DESC
	 */
	public void setINVST_DESC(String iNVST_DESC) {
		INVST_DESC = iNVST_DESC;
	}

	/**
	 * @return oUGHT_INVST_SUM
	 */
	public String getOUGHT_INVST_SUM() {
		return OUGHT_INVST_SUM;
	}

	/**
	 * @param oUGHT_INVST_SUM 要设置的 oUGHT_INVST_SUM
	 */
	public void setOUGHT_INVST_SUM(String oUGHT_INVST_SUM) {
		OUGHT_INVST_SUM = oUGHT_INVST_SUM;
	}

	/**
	 * @return aCTUL_INVST_SUM
	 */
	public String getACTUL_INVST_SUM() {
		return ACTUL_INVST_SUM;
	}

	/**
	 * @param aCTUL_INVST_SUM 要设置的 aCTUL_INVST_SUM
	 */
	public void setACTUL_INVST_SUM(String aCTUL_INVST_SUM) {
		ACTUL_INVST_SUM = aCTUL_INVST_SUM;
	}

	/**
	 * @return iNVST_CURR
	 */
	public String getINVST_CURR() {
		return INVST_CURR;
	}

	/**
	 * @param iNVST_CURR 要设置的 iNVST_CURR
	 */
	public void setINVST_CURR(String iNVST_CURR) {
		INVST_CURR = iNVST_CURR;
	}
	...
	/**
	 * @param hOLD_RATIO 要设置的 hOLD_RATIO
	 */
	 ...
	 * @return iNVST_DATE
	 */
	public String getINVST_DATE() {
		return INVST_DATE;
	}

	/**
	 * @param iNVST_DATE 要设置的 iNVST_DATE
	 */
	public void setINVST_DATE(String iNVST_DATE) {
		INVST_DATE = iNVST_DATE;
	}

	/**
	 * @return sTOCK_CERT_NO
	 */
	public String getSTOCK_CERT_NO() {
		return STOCK_CERT_NO;
	}

	/**
	 * @param sTOCK_CERT_NO 要设置的 sTOCK_CERT_NO
	 */
	public void setSTOCK_CERT_NO(String sTOCK_CERT_NO) {
		STOCK_CERT_NO = sTOCK_CERT_NO;
	}
	...
	/**
	 * @param wORK_RESUME 要设置的 wORK_RESUME
	 */
	...
	/**
	 * @return cREDIT_FINCIL_DESC
	 */
	public String getCREDIT_FINCIL_DESC() {
		return CREDIT_FINCIL_DESC;
	}

	/**
	 * @param cREDIT_FINCIL_DESC 要设置的 cREDIT_FINCIL_DESC
	 */
	public void setCREDIT_FINCIL_DESC(String cREDIT_FINCIL_DESC) {
		CREDIT_FINCIL_DESC = cREDIT_FINCIL_DESC;
	}

	/**
	 * @return iS_WORK_FLAG
	 */
	public String getIS_WORK_FLAG() {
		return IS_WORK_FLAG;
	}

	/**
	 * @param iS_WORK_FLAG 要设置的 iS_WORK_FLAG
	 */
	public void setIS_WORK_FLAG(String iS_WORK_FLAG) {
		IS_WORK_FLAG = iS_WORK_FLAG;
	}

	/**
	 * @return pART_TIME_FLAG
	 */
	public String getPART_TIME_FLAG() {
		return PART_TIME_FLAG;
	}

	/**
	 * @param pART_TIME_FLAG 要设置的 pART_TIME_FLAG
	 */
	public void setPART_TIME_FLAG(String pART_TIME_FLAG) {
		PART_TIME_FLAG = pART_TIME_FLAG;
	}

	/**
	 * @return pART_TIME_DESC
	 */
	public String getPART_TIME_DESC() {
		return PART_TIME_DESC;
	}

	/**
	 * @param pART_TIME_DESC 要设置的 pART_TIME_DESC
	 */
	public void setPART_TIME_DESC(String pART_TIME_DESC) {
		PART_TIME_DESC = pART_TIME_DESC;
	}
