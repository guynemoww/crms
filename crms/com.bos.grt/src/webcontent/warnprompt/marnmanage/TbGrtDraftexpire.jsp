...
<form id="form1" action="" method="post" class="nui-form" style="height:auto;overflow:hidden;">
	<div class="nui-dynpanel" columns="4">
		<label>票据号码：</label>
		<input name="map/draftNum" required="false" class="nui-textbox nui-form-input"  />
		<label>贷款人名称：</label>
	...
	<div id="grid1" class="nui-datagrid" style="width:99.65%;height:auto;margin-top:1px"
		url="com.bos.grt.marnmanage.marnmanage.tbGrtDraftexpire.biz.ext"
		dataField="draft"
		...
		<div property="columns">
			...
			<div field="draftNum" headerAlign="center" allowSort="true" >票据号码</div>
			<div field="type" headerAlign="center" allowSort="true" >押品类型</div>
			<div field="depositReceiptSdate" headerAlign="center" allowSort="true" >票据起始日期</div>
			<div field="draftExpirationDate" headerAlign="center" allowSort="true" >票据到期日期</div>
