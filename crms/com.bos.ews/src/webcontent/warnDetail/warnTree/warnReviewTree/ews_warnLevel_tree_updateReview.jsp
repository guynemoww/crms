    ...
    var menudata = [
		{id:"客户预警", text:"客户预警", //expanded:true, 
			children:[
				...
				{id:"预警级别调整",text:"预警级别调整",url:"/ews/warnDetail/warnLevel/ews_warnLevel_edit.jsp?bizId=<%=request.getParameter("bizId") %>&processInstId=<%=request.getParameter("processInstId")%>&readOnly=1"}
			]},
		{id:"相关文档", text:"相关文档", 
			children:[
