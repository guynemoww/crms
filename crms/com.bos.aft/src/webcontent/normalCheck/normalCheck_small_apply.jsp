...
<div id="form" style="width:99.5%;height:auto;overflow:hidden;">
	...
	<fieldset>
	    ...
	    <div class="nui-dynpanel" columns="4" id="table1">
			...
			<input id="tbAftNormalCheck.checkReason" name="tbAftNormalCheck.checkReason" required="true" 
						class="nui-dictcombobox nui-form-input" dictTypeId="XD_DHBG0003"  />
			...
			<input  id="tbAftNormalCheck.checkPlace" name="tbAftNormalCheck.checkPlace" required="true" class="nui-textbox nui-form-input"  />
	...
	<fieldset>
	    ...
	    <div class="nui-dynpanel" columns="4" id="table2">
			...
			<input  id="tbAftTrackPerson.repayCondition" name="tbAftTrackPerson.repayCondition" required="true" class="nui-textarea nui-form-input"  />
			
			<label class="nui-form-label">检查期限内欠款情况：</label>
			<input  id="tbAftTrackPerson.debtCondition" name="tbAftTrackPerson.debtCondition" required="true" class="nui-textarea nui-form-input"  />
			
			<label class="nui-form-label">逾期原因：</label>
			<input  id="tbAftTrackPerson.exceedReason" name="tbAftTrackPerson.exceedReason" class="nui-textarea nui-form-input"  />
	...
	<fieldset id="table3">
	    ...
	    <div class="nui-dynpanel" columns="4">
			...
			<input id="tbAftTrackPerson.guarantorBusiness" name="tbAftTrackPerson.guarantorBusiness" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="XD_DHMS0001"  />
					
			<label class="nui-form-label">保证人财务状况：</label>
			<input id="tbAftTrackPerson.guarantorFinance" name="tbAftTrackPerson.guarantorFinance" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="XD_DHMS0001"  />
					
			<label class="nui-form-label">保证人与借款人关系：</label>
			<input id="tbAftTrackPerson.guarantorRelation" name="tbAftTrackPerson.guarantorRelation" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="XD_DHMS0001"  />
					
			<label class="nui-form-label">保证人是否发生影响我行债权安全的重大事项：</label>
			<input id="tbAftTrackPerson.isGuarantorDebt" name="tbAftTrackPerson.isGuarantorDebt" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
					
			<label class="nui-form-label">担保有无：</label>
			<input id="tbAftTrackPerson.isGuarantorRisk" name="tbAftTrackPerson.isGuarantorRisk" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CsmHaveOrNot"  /> 
					
			<label class="nui-form-label">担保分析：</label>
			<input  id="tbAftTrackPerson.guarantorOthers" name="tbAftTrackPerson.guarantorOthers" required="true" class="nui-textarea nui-form-input"  />
	...
	<fieldset id="table4">
	    ...
	    <div class="nui-dynpanel" columns="4" >
			...
			<input id="tbAftTrackPerson.isMortgageGood" name="tbAftTrackPerson.isMortgageGood" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
					
			<label class="nui-form-label">抵（质）押物现值是否有重大变化：</label>
			<input id="tbAftTrackPerson.isMortgageChange" name="tbAftTrackPerson.isMortgageChange" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
					
			<label class="nui-form-label">抵（质）押率是否控制在规定的范围内：</label>
			<input id="tbAftTrackPerson.isMortgageControl" name="tbAftTrackPerson.isMortgageControl" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
					
			<label class="nui-form-label">借款人是否擅自改变抵质押物的占管人、使用人：</label>
			<input id="tbAftTrackPerson.isMortgageChaOwn" name="tbAftTrackPerson.isMortgageChaOwn" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
					
			<label class="nui-form-label">借款人是否擅自转让、赠与、出租、设定担保物权等：</label>
			<input id="tbAftTrackPerson.isMortgageRent" name="tbAftTrackPerson.isMortgageRent" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
					
			<label class="nui-form-label">抵（质）押物是否有：</label>
			<input id="tbAftTrackPerson.isMortgageRisk" name="tbAftTrackPerson.isMortgageRisk" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="CDGY0001"  />
	...
	<fieldset id="table5">
	    ...
	    <div class="nui-dynpanel" columns="4" >
			...
			<label class="nui-form-label">担保分析：</label>
			<input  id="tbAftTrackPerson.mortgageOthers" name="tbAftTrackPerson.mortgageOthers" required="true" class="nui-textarea nui-form-input"  />
			
			<label class="nui-form-label">借款人工作单位、地址、联系电话等信息的变更情况，借款人品行、职业、收入、住所和健康状况等影响还款能力和诚意的因素变化情况说明：</label>
			<input  id="tbAftTrackPerson.customerCondition" name="tbAftTrackPerson.customerCondition" required="true" class="nui-textarea nui-form-input"  />
			...
			<input  id="tbAftTrackPerson.otherCondition" name="tbAftTrackPerson.otherCondition" required="true" class="nui-textarea nui-form-input"  />
			
			<label class="nui-form-label">处理意见：</label>
			<input id="tbAftNormalCheck.dealOpinion" name="tbAftNormalCheck.dealOpinion" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="XD_DHBG0004"  />
			
			<label class="nui-form-label">具体建议：</label>
			<input  id="tbAftNormalCheck.opinionDetail" name="tbAftNormalCheck.opinionDetail" required="true" class="nui-textarea nui-form-input"  />
...
<script type="text/javascript">
	...
	function save(){
		...
		//var checkReason= nui.get("o.tbAftNormalCheck.checkReason").getValue();
		//alert();
		//var exceedReason= nui.get("o.tbAftTrackPerson.exceedReason").getValue();
		
		if(o.tbAftNormalCheck.checkReason=="1"){
			if(o.tbAftTrackPerson.exceedReason==null || o.tbAftTrackPerson.exceedReason=="") {
				return nui.alert("请填写逾期原因");
			}
		}
	...
	function savetemp(){
		...
		var json = nui.encode(o);
   		$.ajax({
        url: "com.bos.aft.normalCheck.saveNormalCheckTemp.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
