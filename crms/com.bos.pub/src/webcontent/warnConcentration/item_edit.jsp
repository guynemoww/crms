...
<!-- 
  ...
  - Description:TB_SYS_WARN_CONCENTRATION, com.bos.dataset.sys.TbSysWarnConcentration-->
<head>
<%@include file="/common/nui/common.jsp" %>
</head>
<body>
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<input type="hidden" name="item" class="nui-hidden" /><input type="hidden" name="item._entity" value="com.bos.dataset.sys.TbSysWarnConcentration" class="nui-hidden" />
	<div class="nui-dynpanel" columns="4">
		...
		<label>新增贷款集中度预警阀值：</label>
		<input name="item.newLoanConLimit" required="false" class="nui-textbox nui-form-input" vtype="maxLength:26" />

		<label>存量贷款集中度预警阀值：</label>
		<input name="item.oldLoanConLimit" required="false" class="nui-textbox nui-form-input" vtype="maxLength:26" />
...
function initForm() {
	var json=nui.encode({"item":{"concentrationId":"<%=request.getParameter("itemId") %>",
		"_entity":"com.bos.dataset.sys.TbSysWarnConcentration"}});
	$.ajax({
...
function save() {
	...
	$.ajax({
        url: "com.bos.pub.TbSysWarnConcentration.saveItem.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
