...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%-- #{hiddenData} --%>
	<input id="projectNumber" name="tbOrderMessage.scoreProjectNumber" required="true" class="nui-hidden" vtype="maxLength:4" enabled="false"/>
	<div class="nui-dynpanel" columns="4">
		...
		<label>计分人姓名：</label>
		<input id="xingming" name="tbOrderMessage.scoreName" required="true" allowInput="false"  class="nui-buttonEdit" onbuttonclick="selectCustManeger" />

		<label>计分人工号：</label>
		<input id="gonghao" name="tbOrderMessage.scoreNumber" required="true"  class="nui-textbox nui-form-input"  enabled="false"/>
		<label>计分对象岗位：</label>
		<input  name="tbOrderMessage.scoreObjPost" required="false"  class="nui-textbox nui-form-input"/>
		<label>计分人机构名称：</label>
		...
		<label>计分项目名称：</label>
		<input id="projectName" name="tbOrderMessage.scoreProjectName" allowInput="false"  required="true" class="nui-buttonEdit" vtype="maxLength:60" onbuttonclick="selectPorject"/>
		<label>计分事项：</label>
		<input id="projectMatter" name="tbOrderMessage.scoreMatter" required="true" class="nui-TextArea" vtype="maxLength:300" enabled="false"/>
		<label>计分来源的事项：</label>
		<input  name="tbOrderMessage.scoreFromObj" required="true" class="nui-TextArea" vtype="maxLength:8" />
		<label>应计分：</label>
		...
		<label>状态：</label>
		<input id="state" name="tbOrderMessage.state" required="true" class="nui-dictcombobox nui-form-input" vtype="maxLength:60" dictTypeId="XD_ZT002"   enabled="false"/>
		<label>是否双倍计分：</label>
                ...
                if (action == "ok") {
                   ...
                   //   alert("==="+nui.encode(data)+"=="+nui.encode(projectName));
                       ...
                       nui.get("projectName").setText(projectName);
                        nui.get("projectNumber").setValue(data.scoreMessageId);
