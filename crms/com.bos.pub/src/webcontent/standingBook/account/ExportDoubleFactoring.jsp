...
<center>
 <form id="form1" action="" method="post" enctype="multipart/form-data" >
	<div class="nui-dynpanel" columns="6">
			...
			<label>业务品种：</label>
			<input name="map/productType" allowInput="false" required="false" class="nui-buttonEdit" vtype="maxLength:32" onbuttonclick="selectProduct"/>
			<label>进口保理商名称：</label>
			<input name="map/importName" required="false"  class="nui-textbox nui-form-input" vtype="maxLength:32"/>
			<label>放款金额：</label>
			<div>
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.standingbook.entrustedloan.GetExportDoubleFactList.biz.ext"
	dataField="items"
	...
	<div property="columns" >
		...
		<div field="currencyCd" headerAlign="center" allowSort="true" dictTypeId="CD000001">本次放款币种</div>	
		<div field="loanAmt" headerAlign="center" allowSort="true" dataType="currency">本次放款金额</div>	
		<div field="startDate" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd">本次放款起始日</div>	
		<div field="expirationDate" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd">本次放款到期日</div>	
		<div field="outAccountOrg" headerAlign="center" allowSort="true" >出账机构 </div>	
		<div field="importName" headerAlign="center" allowSort="true" >进口保理商名称</div>	
	</div>
</div>
	</center>
</div>
    ...
    function exportEmp()
    {
		...
		if(rows != null && rows.length > 0) {
	     var form = document.getElementById("form1");
			     form.action = "com.bos.pub.standingbook.accountManager.flow?_eosFlowAction=exportFile&importCd=215";
			     form.submit();
	    }
	    else{
	    nui.alert("没有要导出的记录");
