...
<script type="text/javascript">
	...
	<%String partyNum = request.getParameter("partyNum"); %>
		...
		tabs.setTabs([
			{title:"客户信息", url:nui.context+"/csm/natural/natural_tree.jsp?partyId=<%=corpid %>&qote=1&partyNum=<%=partyNum %>", showCloseButton:false},
			...
			<%--{title:"客户预警", url:nui.context+"/ews/warnDetail/ews_warn_main.jsp?corpid=<%=corpid %>&type=02",refreshOnClick:true},
