...
<div id="form" style="width:99.5%;height:auto;overflow:hidden; text-align:center;"  class="nui-form">
	<div class="nui-toolbar" style="border-bottom:0;text-align:left;">
		...
		<!-- <a class="nui-button" iconCls="icon-edit"  onclick="edit(0)" id="editBtn">追加保证金</a> -->
	...
	<div id="grid" class="nui-datagrid" style="width:100%;height:auto" 
		url="com.bos.grt.conGrt.getConGRTBZJRecordList.biz.ext"allowAlternating="true"
...
<script type="text/javascript">
            ...
            success: function (mydata) {
				...
				$.ajax({
		            ...
		            success: function (mydata) {
	            		...
	            		nui.open({
				            url: nui.context+"/crt/con_grt/con_grt_bzj_rel.jsp?subcontractId="+subcontractId+"&contractId="+contractId+"&applyId="+applyId+"&subcontractType=04&partyId="+partyId+"&xgbz="+xgbz+"&view="+view,
				            showMaxButton: true,
				            title: "保证金明细信息",
				            width: 800,
				            height: 500,
    ...
    function edit(v){     
        ...
        if(row){
	        nui.open({
	            url: nui.context + "/crt/con_grt/con_bzj_tab1.jsp?subcontractId="+row.SUBCONTRACT_ID+"&contractId="+contractId+"&view="+v+"&applyId="+applyId+"&partyId="+partyId+"&xgbz="+xgbz,
	            title: "担保合同信息", 
	            width: 800,
	    		height: 500,
	    		state:"max",
