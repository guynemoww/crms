 ...
 *
 */
public class EsbBodyEcifRqGLoAdrArray implements Serializable {
	...
	private String strAdr;		//街道地址		String(120)		
	private String rgonNo;		//地区编号		String(19)		
	private String offcAdr;		//办公地址		String(60)
	private String dfltAdrFlg;	//默认地址标志	String(3)		"1是0否-1未知"
	
	public EsbBodyEcifRqGLoAdrArray(){
