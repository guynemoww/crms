...
<script type="text/javascript">
	...
	function save(){
       ...
       /*  var yhze = nui.get("tbConLoanChange.yhze").getValue();
        var AcctNo = nui.get("tbConLoanChange.oldRepayAccount").getValue();
    	 ...
    	 var json=nui.encode({"acctInd":AcctNo});
		  $.ajax({
	        ...
	        success: function (text) {
	        	...
	        	var avlBal = text.queryAcc.avlBal;//返回的可用余额
				if(yhze > avlBal) {
		...
		$.ajax({
            ...
            success: function (mydata) {
            	if(mydata.msg) {
            		...
            		nui.get("tbConLoanChange.yhze").setValue(mydata.items.padUpAmt);
            		nui.get("tbConLoanChange.yhbj").setValue(mydata.items.rcvPrn);
            		nui.get("tbConLoanChange.yhzclx").setValue(yhzclx);
            		nui.get("tbConLoanChange.yhtqlx").setValue(mydata.items.rcvDftItrIn);
            		nui.get("tbConLoanChange.yhfx").setValue(yhfx);
            		nui.get("tbConLoanChange.yhfl").setValue(yhfl);
            	}
            	//initPage();
			}
    	});
		...
		$.ajax({
            ...
            success: function (mydata) {
            	if(mydata.msg) {
            		...
            		nui.get("tbConLoanChange.yhze").setValue(yhze);
            		nui.get("tbConLoanChange.yhbj").setValue(yhbj);
            		nui.get("tbConLoanChange.yhzclx").setValue(yhzclx);
            		nui.get("tbConLoanChange.yhtqlx").setValue(mydata.items.rcvDftItrIn);
            		nui.get("tbConLoanChange.yhfx").setValue(yhfx);
