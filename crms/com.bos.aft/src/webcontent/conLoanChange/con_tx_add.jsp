...
<center>
	...
	<div class="nui-dynpanel" columns="4">
		<label>贴息方式：</label>
		<input id="tbConLoanTx.txfs" name="tbConLoanTx.txfs" class="nui-dictcombobox nui-form-input"
...
<script type="text/javascript">
	...
	var bglx = "<%=request.getParameter("bglx") %>";
	...
	function create(){
		...
		//贴息方式处理---end
        o.tbConLoanTx.applyId=applyId;
        o.tbConLoanTx.changeId=changeId;
        o.tbConLoanTx.bglx=bglx;
