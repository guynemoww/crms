...
/**
 * 
 * @ClassName: EsbBodyMtmqRq02003000004A05
 * @Description: 02003000004信贷信息查询 05合同信息查询
 * 
 */
@XmlRootElement(name = "BODY")
public class EsbBodyMtmqRq02003000004A05 extends EsbBody implements Serializable {
	...
	private String ctrSt;// 合同状态 String(4) N 01:未提交，02：审批中，03：已生效
	private String pgRcrdNum;// 每页记录数 String(10) Y 默认10条
	private String crnPgNo;// 当前页码 String(10) Y
	
	public EsbBodyMtmqRq02003000004A05() {
