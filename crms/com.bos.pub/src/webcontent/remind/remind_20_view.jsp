...
<body>
	...
	<div class="nui-fit">
		<div id="grid1" class="nui-datagrid" style="height: 100%;" sortMode="client" url="com.bos.pub.Remind.getRemindInfoByType.biz.ext" dataField="items" multiSelect="false">
			<div property="columns">
				...
				<div field="CONTRACT_END_DATE" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd">合同到期日</div>
				<div field="HYPOTHEC_NUM" headerAlign="center" allowSort="true">担保合同编号</div>
				<div field="HYPOTHEC_END_DATE" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd">担保合同到期日</div>
				<div field="TO_END_DATE" headerAlign="center" allowSort="true">担保合同到期剩余天数</div>
			</div>
		</div>
	</div>
	<script type="text/javascript">
		...
		var remindType =
	<%=JspUtil.getParameterHaveSign(request, "remindType")%>
		;
