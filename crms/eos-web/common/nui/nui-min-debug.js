mini = {
    ...
    getbyName: function(d, a) {
        ...
        a = mini.byId(a);
        a = a || document.body;
        var c = this.findControls(function(f) {
            if (!f.el) {
                return false
            }
            if (f.name == d && mini.isAncestor(a, f.el)) {
                return 1
            }
            return false
        },
...
mini._FireBindEvents = function() {
    for (var b = 0,
    a = mini._BindCallbacks.length; b < a; b++) {
...
mini.extend(mini.ValidatorBase, mini.Control, {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, a, ["onvaluechanged", "onvalidation", "requiredErrorText", "errorMode"]);
        mini._ParseBool(b, a, ["validateOnChanged", "validateOnLeave"]);
        var c = b.getAttribute("required");
        if (!c) {
            c = b.required
        }
        if (c) {
            a.required = c != "false" ? true: false
        }
        return a
    }
});
...
mini.extend(mini.ListControl, mini.ValidatorBase, {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, h, ["url", "data", "value", "textField", "valueField", "onitemclick", "onitemmousemove", "onselectionchanged", "onitemdblclick", "onbeforeload", "onload", "onloaderror", "ondataload"]);
        ...
        if (!f) {
            ...
            e = d.length; g < e; g++) {
                ...
                if (h) {
                    ...
                    b = k.el;
                    //nui.paser完成后 调用validate 强制验证 出现感叹标识
                    //if(k.validate){
					//    k.validate();
				    //} 
                    break
...
mini.IndexColumn = function(a) {
    return mini.copyTo({
        width: 40,//王世春：原为30像素，实际上，30像素不够，会造成换行
        cellCls: "",
        align: "center",
        draggable: false,
        allowDrag: true,
...
mini.createIFrame = function(b, i) {
    var c = "__iframe_onload" + mini.__IFrameCreateCount++;
    window[c] = d;
    if (!b) {
        b = ""
    }
    ...
    var k = '<iframe style="width:100%;height:100%;" onload="' + c + '()"  frameborder="0"></iframe>';
    var a = document.createElement("div");
    var f = mini.append(a, k);
    var e = false;
    setTimeout(function() {
        if (f) {
            f.src = b;
    ...
    maxLength: function(a, b) {
		...
		for(var i=0;i<a.length;i++){
			...
			if(re.test(t)){
				...
				len = Number(len)+3;//如果是中文，增加3长度
			}
		}
        if(len <= c){
        //修改中文所占长度为3，其余字符长度1--end
        //if (a.length <= c) {
            return true
        } else {
            return false
...
mini.formatCurrencyNew = function(a, c) {
	...
	/*
	if (rvalue.indexOf('.')==rvalue.length-1) {
...
mini.formatCurrency = function(a, c) {
    ...
    /*a = Math.floor(a * 100+0.00000000005);//a = Math.floor(a * 100 + 0.50000000001);四舍五入，不启用 lvjianhao/2014/11/12
    cents = a % 100;
    console.log(a+"--"+cents);
...
mini.dateInfo = {
    monthsLong: ["ä¸æ", "äºæ", "ä¸æ", "åæ", "äºæ", "å­æ", "ä¸æ", "å«æ", "ä¹æ", "åæ", "åä¸æ", "åäºæ"],
    monthsShort: ["1æ", "2æ", "3æ", "4æ", "5æ", "6æ", "7æ", "8æ", "9æ", "10æ", "11æ", "12æ"],
    daysLong: ["æææ¥", "ææä¸", "ææäº", "ææä¸", "ææå", "ææäº", "ææå­"],
    daysShort: ["æ¥", "ä¸", "äº", "ä¸", "å", "äº", "å­"],
    quarterLong: ["ä¸å­£åº¦", "äºå­£åº¦", "ä¸å­£åº¦", "åå­£åº¦"],
    quarterShort: ["Q1", "Q2", "Q2", "Q4"],
    halfYearLong: ["ä¸åå¹´", "ä¸åå¹´"],
    patterns: {
        d: "yyyy-M-d",
        D: "yyyyå¹´Mædæ¥",
        f: "yyyyå¹´Mædæ¥ H:mm",
        F: "yyyyå¹´Mædæ¥ H:mm:ss",
        g: "yyyy-M-d H:mm",
        G: "yyyy-M-d H:mm:ss",
        m: "MMMdæ¥",
        o: "yyyy-MM-ddTHH:mm:ss.fff",
...
mini.mask = function(c) {
    ...
    var bscHeight = scrollHeight <= clientHeight?clientHeight:scrollHeight;
    var bsc = c.backStyle + ";height:" + bscHeight + "px";
    var f = mini.append(d, '<div class="mini-mask"><div class="mini-mask-background" style="' + bsc + '"></div><div class="mini-mask-msg ' + c.cls + '" style="' + c.style + '">' + c.html + "</div></div>");
    c.maskEl = f;
...
mini.extend(mini.Button, mini.Control, {
    ...
    doUpdate: function() {
        ...
        c = this.text;
        if (this.iconCls && c) {
            a = " mini-button-icon " + this.iconCls
        } else {
            if (this.iconCls && c === "") {
                a = " mini-button-iconOnly " + this.iconCls;
                c = "&nbsp;"
            } else {
                if (c == "") {
                    c = "&nbsp;"
        ...
        var b = '<span class="mini-button-text ' + a + '">' + c + "</span>";
        if (this.allowCls) {
            b = b + '<span class="mini-button-allow ' + this.allowCls + '"></span>'
        }
        this.el.innerHTML = b
    },
    href: "",
...
mini.extend(mini.ButtonEdit, mini.ValidatorBase, {
    ...
    getAttrs: function(b) {
        ...
        var c = jQuery(b);
        mini._ParseString(b, a, ["value", "text", "textName", "emptyText", "inputStyle", "onenter", "onkeydown", "onkeyup", "onkeypress", "onbuttonclick", "onbuttonmousedown", "ontextchanged", "onfocus", "onblur", "oncloseclick"]);
...
mini.extend(mini.TextBox, mini.ValidatorBase, {
    ...
    getAttrs: function(b) {
        ...
        var c = jQuery(b);
        mini._ParseString(b, a, ["value", "text", "emptyText", "inputStyle", "onenter", "onkeydown", "onkeyup", "onkeypress", "maxLengthErrorText", "minLengthErrorText", "onfocus", "onblur", "vtype", "emailErrorText", "urlErrorText", "floatErrorText", "intErrorText", "dateErrorText", "minErrorText", "maxErrorText", "rangeLengthErrorText", "rangeErrorText", "rangeCharErrorText"]);
...
mini.extend(mini.ComboBox, mini.PopupEdit, {
    ...
    _createPopup: function() {
        ...
        var a = this;
        this._listbox.on("beforeload",
        function(b) {
            a.fire("beforeload", b)
        },
        this);
        this._listbox.on("load",
        function(b) {
            a.fire("load", b)
        },
        this);
        this._listbox.on("loaderror",
        function(b) {
            a.fire("loaderror", b)
        },
        this)
    ...
    _doQuery: function(e) {
        ...
        var b = [];
        for (var d = 0,
        a = this.data.length; d < a; d++) {
            var h = this.data[d];
            var g = mini._getMap(this.textField, h);
            if (typeof g == "string") {
                g = g.toUpperCase();
                e = e.toUpperCase();
                if (g.indexOf(e) != -1) {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, m, ["url", "data", "textField", "valueField", "displayField", "nullItemText", "ondrawcell", "onbeforeload", "onload", "onloaderror", "onitemclick"]);
        mini._ParseBool(b, m, ["multiSelect", "showNullItem", "valueFromSelect"]);
        if (m.displayField) {
...
mini.extend(mini.DatePicker, mini.PopupEdit, {
    ...
    showPopup: function() {
    	var d;
    	mini.ajax({
	        url: "com.bos.comm.pub.PubUtil.getBusiDate.biz.ext",
	        type: "POST",
	        async: false,
	        success: function(f) {
	            d = f.date;//获取业务时间为今天
		...
		this.viewDate = mini.parseDate(d);
        var a = {
            cancel: false
        };
        this.fire("beforeshowpopup", a);
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, a, ["format", "viewDate", "timeFormat", "ondrawdate", "minDate", "maxDate", "valueFormat"]);
        mini._ParseBool(b, a, ["showTime", "showTodayButton", "showClearButton", "showOkButton"]);
        return a
    }
});
...
mini.extend(mini.Calendar, mini.Control, {
    ...
    _CreateView: function(m, d, a) {
        ...
        var c = mini.clearTime(this.viewDate).getTime();
    ...
    updateMenu: function() {
        ...
        for (var c = this.menuYear,
        b = this.menuYear + 10; c < b; c++) {
            var e = c;
            var a = "";
    ...
    __OnClick: function(j) {
        ...
        var l = j.target;
        var b = mini.findParent(j.target, "mini-calendar-title");
        if (mini.findParent(l, "mini-calendar-monthNext")) {
            ...
            if (mini.findParent(l, "mini-calendar-yearNext")) {
                ...
                if (mini.findParent(l, "mini-calendar-monthPrev")) {
                    m.setMonth(m.getMonth() - 1);
                    this.setViewDate(m)
                } else {
                    if (mini.findParent(l, "mini-calendar-yearPrev")) {
                        m.setFullYear(m.getFullYear() - 1);
                        this.setViewDate(m)
                    } else {
                        if (mini.findParent(l, "mini-calendar-tadayButton")) {
                            var k;
                            //同步获取业务时间
                            mini.ajax({
						        url: "com.bos.comm.pub.PubUtil.getBusiDate.biz.ext",
                            ...
                            if (mini.findParent(l, "mini-calendar-clearButton")) {
                                this.setSelectedDate(null);
                                this.setTime(null);
                                this._OnDateClick(null, "clear")
                            } else {
                                if (mini.findParent(l, "mini-calendar-okButton")) {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseBool(b, a, ["multiSelect", "showHeader", "showFooter", "showWeekNumber", "showDaysHeader", "showMonthButtons", "showYearButtons", "showTodayButton", "showClearButton", "showTime", "showOkButton"]);
        return a
    }
});
...
mini.extend(mini.ListBox, mini.ListControl, {
    ...
    doLayout: function() {
        ...
        if (isIE) {
            var d = this._headerEl.firstChild,
            c = this._viewEl.firstChild;
...
mini.extend(mini.TreeSelect, mini.PopupEdit, {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, a, ["url", "data", "textField", "valueField", "nodesField", "parentField", "onbeforenodecheck", "onbeforenodeselect", "expandOnLoad", "onnodeclick", "onbeforeload", "onload", "onloaderror"]);
        mini._ParseBool(b, a, ["multiSelect", "resultAsTree", "checkRecursive", "showTreeIcon", "showTreeLines", "showFolderCheckBox", "autoCheckParent", "valueFromSelect"]);
        if (a.expandOnLoad) {
...
mini.extend(mini.Spinner, mini.ButtonEdit, {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, a, ["minValue", "maxValue", "increment", "decimalPlaces", "changeOnMousewheel"]);
        mini._ParseBool(b, a, ["allowLimitValue"]);
        return a
    }
});
...
mini.extend(mini.TimeSpinner, mini.ButtonEdit, {
    ...
    setValue: function(a) {
        ...
        if (mini.formatDate(this.value, "H:mm:ss") != mini.formatDate(a, "H:mm:ss")) {
            this.value = a;
            this.text = this._textEl.value = this.getFormattedValue();
            this._valueEl.value = this.getFormValue()
        }
...
mini.extend(mini.HtmlFile, mini.ButtonEdit, {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, a, ["limitType", "buttonText", "limitTypeErrorText"]);
        return a
    }
});
...
mini.extend(mini.FileUpload, mini.ButtonEdit, {
    ...
    getAttrs: function(b) {
        ...
        mini._ParseString(b, a, ["limitType", "limitSize", "flashUrl", "uploadUrl", "uploadLimit", "onuploadsuccess", "onuploaderror", "onuploadcomplete", "onfileselect"]);
...
mini.extend(mini.TextBoxList, mini.ValidatorBase, {
    ...
    getAttrs: function(b) {
        var a = mini.TextBox.superclass.getAttrs.call(this, b);
        var c = jQuery(b);
        mini._ParseString(b, a, ["value", "text", "valueField", "textField", "url", "popupHeight", "textName", "onfocus", "onbeforeload", "onload", "searchField"]);
    ...
    __OnInputKeyDown: function(f) {
        ...
        case 13:
            if (this.isShowPopup()) {
                ...
                if (a != -1) {
                    var b = this._listbox.getAt(a);
                    var d = this._listbox.getValueAndText([b]);
                    var c = d[0];
                    this.setText(d[1]);
                    if (mini.isFirefox) {
                        this.blur();
        ...
        case 38:
            ...
            if (a == -1) {
                a = 0;
                if (!this.multiSelect) {
                    var b = this._listbox.findItems(this.value)[0];
                    if (b) {
                        a = this._listbox.indexOf(b)
                    }
                }
            }
            if (this.isShowPopup()) {
    ...
    _doQuery: function(b) {
        ...
        mini.copyTo(d, {
            success: function(i) {
                ...
                if (mini.isNumber(h.error) && h.error != 0) {
                    var e = {};
...
mini.extend(mini.Panel, mini.Container, {
    ...
    set: function(d) {
        ...
        var a = d.url;
        delete d.url;
        mini.Panel.superclass.set.call(this, d);
        if (c) {
            this.setToolbar(c)
        }
        if (e) {
    ...
    doLayout: function() {
        ...
        var a = mini.getWidth(this._viewportEl, true);
        var d = a;
        if (!c) {
    ...
    _doTools: function() {
        ...
        for (var b = this.buttons.length - 1; b >= 0; b--) {
            ...
            c += '<span id="' + b + '" class="' + a.cls + " " + (a.enabled ? "": "mini-disabled") + '" style="' + a.style + ";" + (a.visible ? "": "display:none;") + '"></span>'
        }
    ...
    _doLoad: function() {
        ...
        var b = mini.createIFrame(this.url,
        function(h, g) {
    ...
    getAttrs: function(d) {
        ...
        mini._ParseString(d, a, ["title", "iconCls", "iconStyle", "headerCls", "headerStyle", "bodyCls", "bodyStyle", "footerCls", "footerStyle", "toolbarCls", "toolbarStyle", "footer", "toolbar", "url", "closeAction", "loadingMsg", "onbeforebuttonclick", "onbuttonclick", "onload"]);
        mini._ParseBool(d, a, ["allowResize", "showCloseButton", "showHeader", "showToolbar", "showFooter", "showCollapseButton", "refreshOnExpand", "maskOnLoad", "expanded"]);
...
mini.extend(mini.Window, mini.Panel, {
    ...
    _doModal: function() {
        ...
        function c() {
            ...
            var f = parseInt(Math.max(document.body.scrollWidth, e ? e.scrollWidth: 0));
            var i = parseInt(Math.max(document.body.scrollHeight, e ? e.scrollHeight: 0));
            ...
            this._modalEl.style.width = h + "px";
            this._modalEl.style.zIndex = mini.getStyle(this.el, "zIndex") - 1
        }
        if (a) {
            var b = this;
    ...
    show: function(a, g, b) {
        ...
        if (!this.isRender() || this.el.parentNode != d) {
            this.render(d)
        }
        this.el.style.zIndex = mini.getMaxZIndex();
        this._doShow(a, g);
    ...
    __OnClick: function(a) {
        mini.Window.superclass.__OnClick.call(this, a);
        if (this.el) {
            this.el.style.zIndex = mini.getMaxZIndex()
        }
    },
    ...
    __OnWindowMouseDown: function(d) {
        ...
        if (this.state != "max" && this.allowDrag && mini.isAncestor(this._headerEl, d.target) && !mini.findParent(d.target, "mini-tools")) {
            ...
            var a = new mini.Drag({
                capture: false,
                onStart: function() {
                    c._maskProxy = mini.append(document.body, '<div class="mini-resizer-mask"></div>');
    ...
    getAttrs: function(b) {
        ...
        mini._ParseBool(b, a, ["showModal", "showShadow", "allowDrag", "allowResize", "showMaxButton", "showMinButton"]);
...
mini.extend(mini.Splitter, mini.Control, {
    ...
    getAttrs: function(c) {
        ...
        mini._ParseBool(c, k, ["allowResize", "vertical", "showHandleButton", "onresize"]);
        ...
        e = 2; f < e; f++) {
            ...
            mini._ParseString(d, b, ["cls", "size", "id", "class"]);
...
mini.extend(mini.Layout, mini.Control, {
    ...
    _CreateRegionEl: function(a) {
        ...
        mini.append(this._borderEl, '<div id="' + a.region + '" class="mini-layout-region"><div class="mini-layout-region-header" style="' + a.headerStyle + '"></div><div class="mini-layout-region-body" style="' + a.bodyStyle + '"></div></div>');
        ...
        if (a.region != "center") {
            mini.append(this._borderEl, '<div uid="' + this.uid + '" id="' + a.region + '" class="mini-layout-split"><div class="mini-layout-spliticon"></div></div>');
...
mini.copyTo(mini.Layout.prototype, {
    ...
    __OnDocMouseDown: function(d) {
        ...
        for (var b = 0,
        a = this.regions.length; b < a; b++) {
            var c = this.regions[b];
            if (!c._Expanded) {
                continue
            }
            if (mini.isAncestor(c._el, d.target) || mini.isAncestor(c._proxy, d.target)) {} else {
    ...
    getAttrs: function(c) {
        ...
        f = a.length; h < f; h++) {
            ...
            mini._ParseString(e, b, ["region", "title", "iconCls", "iconStyle", "cls", "headerCls", "headerStyle", "bodyCls", "bodyStyle"]);
...
mini.extend(mini.Tabs, mini.Control, {
    ...
    doLayout: function() {
        ...
        var u = this.isAutoHeight();
        y = this.getHeight(true);
        ...
        if (!u && this.showBody) {
            var t = jQuery(this._headerEl).outerHeight();
            var d = jQuery(this._headerEl).outerWidth();
            if (this.tabPosition == "top") {
                t = jQuery(this._headerEl.parentNode).outerHeight()
            }
            ...
            if (jQuery.boxModel) {
                var n = mini.getPaddings(this._bodyEl);
                var r = mini.getBorders(this._bodyEl);
                y = y - n.top - n.bottom - r.top - r.bottom;
                w = w - n.left - n.right - r.left - r.right
            }
            margin = mini.getMargins(this._bodyEl);
            y = y - margin.top - margin.bottom;
            ...
            this._bodyEl.style.height = y + "px";
            if (this.tabPosition == "left" || this.tabPosition == "right") {
                var a = this._headerEl.getElementsByTagName("tr")[0];
                var v = a.childNodes;
                var m = v[0].getElementsByTagName("tr");
                var e = last = all = 0;
                for (var x = 0,
                s = m.length; x < s; x++) {
                    var a = m[x];
                    var j = jQuery(a).outerHeight();
                    all += j;
                    if (x == 0) {
                        e = j
                    }
                ...
                case "center":
                    var o = parseInt((k - (all - e - last)) / 2);
                    for (var x = 0,
                    s = v.length; x < s; x++) {
                        v[x].firstChild.style.height = k + "px";
                        var g = v[x].firstChild;
                        var m = g.getElementsByTagName("tr");
                        var A = m[0],
                        z = m[m.length - 1];
                        A.style.height = o + "px";
                        z.style.height = o + "px"
        ...
        if (c) {
            if (!u && this.showBody) {
                var y = mini.getHeight(this._bodyEl, true);
                if (jQuery.boxModel) {
                    var n = mini.getPaddings(c);
                    var r = mini.getBorders(c);
                    y = y - n.top - n.bottom - r.top - r.bottom
                }
                c.style.height = y + "px"
            } else {
        ...
        case "bottom":
            ...
            break;
        case "left":
            var v = this._headerEl.firstChild.rows[0].cells;
            for (var x = 0,
            s = v.length; x < s; x++) {
                var f = v[x];
                mini.removeClass(f, "mini-tabs-header2");
                if (s > 1 && x == 0) {
                    mini.addClass(f, "mini-tabs-header2")
                }
            }
            break;
        case "right":
    ...
    setActiveIndex: function(k, d) {
        var b = this.getTab(k);
        var u = this.getTab(this.activeIndex);
        var q = b != u;
        var a = this.getTabBodyEl(this.activeIndex);
        if (a) {
            a.style.display = "none"
        ...
        var a = this.getTabEl(u);
        if (a) {
            mini.removeClass(a, this._tabActiveCls)
        }
        var a = this.getTabEl(b);
        if (a) {
            mini.addClass(a, this._tabActiveCls)
        }
        if (a && q) {
            if (this.tabPosition == "bottom") {
                var f = mini.findParent(a, "mini-tabs-header");
                if (f) {
                    jQuery(this._headerEl).prepend(f)
                }
            } else {
                if (this.tabPosition == "left") {
                    var c = mini.findParent(a, "mini-tabs-header").parentNode;
                    if (c) {
                    ...
                    if (this.tabPosition == "right") {
                        var c = mini.findParent(a, "mini-tabs-header").parentNode;
                        if (c) {
                            jQuery(c.parentNode).prepend(c)
                        }
                    } else {
                        var f = mini.findParent(a, "mini-tabs-header");
                        if (f) {
                            this._headerEl.appendChild(f)
                        }
                    }
                }
            }
            var n = this._headerEl.scrollLeft;
            this.doLayout();
            var h = this.getTabRows();
            if (h.length > 1) {} else {
                if (this.tabPosition == "top") {
                    this._headerEl.scrollLeft = n;
                    var g = this.getTabEl(this.activeIndex);
                    if (g) {
                        var t = this;
                        var j = mini.getBox(g);
                        var r = mini.getBox(t._headerEl);
                        if (j.x < r.x) {
                            t._headerEl.scrollLeft -= (r.x - j.x)
                        } else {
                            if (j.right > r.right) {
                                t._headerEl.scrollLeft += (j.right - r.right)
                            }
                        }
                    }
                }
            ...
            for (var o = 0,
            m = this.tabs.length; o < m; o++) {
                var g = this.getTabEl(this.tabs[o]);
                if (g) {
                    mini.removeClass(g, this._tabHoverCls)
                }
            }
        }
        var s = this;
        if (q) {
            ...
            setTimeout(function() {
                s.fire("ActiveChanged", p)
            },
            1)
        }
        this._cancelLoadTabs(b);
        if (d !== false) {
            if (b && b.url && !b.loadedUrl) {
                var s = this;
                s.loadTab(b.url, b)
            }
        }
    ...
    __OnClick: function(c) {
        ...
        if (a.enabled) {
            var b = this;
            setTimeout(function() {
                if (mini.findParent(c.target, "mini-tab-close")) {
    ...
    _doUpdateTop: function() {
        ...
        if (p) {
            ...
            v += '<a class="mini-tabs-leftButton" href="javascript:void(0)" hideFocus onclick="return false"></a><a class="mini-tabs-rightButton" href="javascript:void(0)" hideFocus onclick="return false"></a>'
        }
...
mini.copyTo(mini.Menu.prototype, {
    ...
    doLayout: function() {
        ...
        if (!this.isAutoHeight()) {
            ...
            if (this.showNavArrow && this._borderEl.scrollHeight > this._borderEl.clientHeight) {
                ...
                var d = mini.getHeight(this._topArrowEl);
                var b = mini.getHeight(this._bottomArrowEl);
                var c = a - d - b;
                if (c < 0) {
                    c = 0
                }
                mini.setHeight(this._contentEl, c)
            } else {
                this._contentEl.style.height = "auto"
            }
        } else {
    ...
    getAttrs: function(b) {
        ...
        var c = jQuery(b);
        mini._ParseString(b, k, ["popupEl", "popupCls", "showAction", "hideAction", "xAlign", "yAlign", "modalStyle", "onbeforeopen", "open", "onbeforeclose", "onclose", "url", "onitemclick", "onitemselect", "textField", "idField", "parentField", "toolbar"]);
        mini._ParseBool(b, k, ["resultAsTree", "hideOnClick", "showNavArrow"]);
...
mini.extend(mini.OutlookBar, mini.Control, {
    ...
    doUpdate: function() {
        for (var c = 0,
        a = this.groups.length; c < a; c++) {
            var f = this.groups[c];
            var h = f._el;
            var g = h.firstChild;
            var e = h.lastChild;
            var b = '<div class="mini-outlookbar-icon ' + f.iconCls + '" style="' + f.iconStyle + ';"></div>';
            var d = '<div class="mini-tools"><span class="mini-tools-collapse"></span></div>' + ((f.iconStyle || f.iconCls) ? b: "") + '<div class="mini-outlookbar-groupTitle">' + f.title + '</div><div style="clear:both;"></div>';
            g.innerHTML = d;
            if (f.enabled) {
    ...
    getAttrs: function(c) {
        ...
        mini._ParseString(c, b, ["onactivechanged", "oncollapse", "onexpand"]);
...
mini.extend(mini.OutlookMenu, mini.OutlookBar, {
    ...
    getAttrs: function(b) {
        ...
        a.text = b.innerHTML;
        mini._ParseString(b, a, ["url", "textField", "urlField", "idField", "parentField", "itemsField", "iconField", "onitemclick", "onitemselect"]);
...
mini.extend(mini.OutlookTree, mini.OutlookBar, {
    ...
    getAttrs: function(b) {
        ...
        a.text = b.innerHTML;
        mini._ParseString(b, a, ["url", "textField", "urlField", "idField", "parentField", "nodesField", "iconField", "onnodeclick", "onnodeselect", "onnodemousedown", "expandOnLoad"]);
        mini._ParseBool(b, a, ["resultAsTree"]);
        if (a.expandOnLoad) {
            var c = parseInt(a.expandOnLoad);
            if (mini.isNumber(c)) {
...
mini.extend(mini.ToolBar, mini.Container, {
    ...
    getAttrs: function(b) {
        var a = {};
        mini._ParseString(b, a, ["id", "borderStyle"]);
        this.el = b;
        this.el.uid = this.uid;
        this.addCls(this.uiCls);
        return a
...
mini.extend(mini.Pager, mini.Control, {
    ...
    _create: function() {
        ...
        var a = '<div class="mini-pager-left"></div><div class="mini-pager-right"></div>';//去除Right 
        this.el.innerHTML = a;
        this.buttonsEl = this._leftEl = this.el.childNodes[0];
        this._rightEl =this.el.childNodes[1] //mini.append(this._leftEl, '<span class="mini-pager-size"></span>');//将分页文字放入Left
    ...
    update: function(e, p, j) {
        ...
        if (m) {
            m.style.display = this.showReloadButton ? "": "none"
        }
...
mini.extend(mini.DataBinding, mini.Component, {
    ...
    __OnCurrentChanged: function(g) {
        ...
        var f = g.record;
        for (var d = 0,
        b = this._bindFields.length; d < b; d++) {
    ...
    __OnValueChanged: function(g) {
        ...
        var m = d.getValue();
        for (var f = 0,
        b = this._bindFields.length; f < b; f++) {
...
mini.extend(mini.DataSource, mini.Component, {
    ...
    updateRecord: function(a, e, c) {
        ...
        if (typeof e == "string") {
            var b = a[e];
            if (mini.isEquals(b, c)) {
                return false
            }
            this.beginChange();
            a[e] = c;
            this._setModified(a, e, b);
            this.endChange()
        } else {
            this.beginChange();
            for (var d in e) {
    ...
    _doLoadAjax: function(d, m, l, b, i) {
        ...
        mini.copyTo(h.data, g);
        mini.copyTo(h, this.ajaxOptions);
        ...
        mini.copyTo(h, {
            success: function(t, u, s) {
                ...
                if (e && !mini.isArray(e)) {//刘子良 2014/10/13 添加、修改[修改了当datagrid记录为1条记录的时候，滚动条遮住记录的问题]
                       dglen = parseInt(mini._getMap(j.totalField, e));
                       /*
                       		lvjianhao  14/10/18
                        	避免初始数据一条，再次增加时只有DataGrid load的时候，依然是固定高度，此时需要设置高度为Auto
                       */
                       /*
                        * lpc 20160823 最后一页只有一条时固定高度
                        */
                       var str_css_height = "auto";
                       if(d.pageIndex == parseInt(dglen/d.pageSize)&&(dglen%d.pageSize==1)){//最后一页且最后一页条数为1
                    	   str_css_height = "auto";
                       }
                       if(dglen==0){
                    	   str_css_height = "auto";
...
//                	   }
                       ...
                       /*var str_css_height = "80px";//设置默认高度为Auto
                       //alert(dglen);
                       if(dglen!='1'||dglen!='0'){
                    	   str_css_height = "auto";			
                    	 
                    	   if(isNaN(dglen)){
                    		   str_css_height = "350px";	
                    	   }else{
                    		   str_css_height = "auto";	
                    	   }
                       ...
                       var str_css = '.mini-grid-rows-view {height:'+str_css_height+'; min-height:75px}';//定义css内容
							...
							*/
                            ...
                            //document.createStyleSheet(str_css);
                       		
                            
					    
                			var style = document.createElement("style");
                			   style.type = "text/css";
                			   style.styleSheet.cssText=str_css;
					           style.textContent = str_css;
					           document.getElementsByTagName("HEAD").item(0).appendChild(style);		
                     }   
...
mini.extend(mini.DataTree, mini.DataSource, {
    ...
    _doLoadData: function(h) {
        ...
        this.dataview = null;
        this.visibleRows = null;
        var g = mini.treeToArray(h, this.nodesField);
        var e = this._ids;
        ...
        var g = mini.treeToArray(h, this.nodesField, "_id", "_pid", this.root._id);
        for (var c = 0,
        b = g.length; c < b; c++) {
            var f = g[c];
...
mini.extend(mini.ColumnModel, mini.Component, {
    ...
    _updateColumnsView: function() {
        ...
        function init(column, index, parentColumn) {
            ...
            if (mini.isNull(column.width)) {
                ...
                //王世春：上面的行去掉，避免横向滚动条，下面是测试代码
                //if (this.columns && this.columns.length>index) {
                	//var w=90/this.columns.length;
                	//column.width = w + "%";
                //}
            }
    ...
    getFrozenColumns: function() {
        ...
        d = this.isFrozen();
        for (var b = 0,
        a = this._visibleColumns.length; b < a; b++) {
    ...
    _createFrozenColSpan: function() {
        ...
        this._columnsRow2 = [];
        for (var n = 0,
        f = this._visibleColumnsRow.length; n < f; n++) {
...
mini.extend(mini.GridView, mini.Panel, {
    ...
    _create: function() {
        ...
        var e = this.el;
        mini.addClass(e, "mini-grid");
        mini.addClass(this._viewportEl, "mini-grid-viewport");
        var a = '<div class="mini-grid-pager"></div>';
        var d = '<div class="mini-grid-filterRow"><div class="mini-grid-filterRow-view"></div><div class="mini-grid-scrollHeaderCell"></div></div>';
        ...
        this._filterEl = mini.after(this._columnsEl, d);
    ...
    doLayout: function() {
        ...
        function e(h) {
            if (this.isFitColumns()) {
                ...
                b.style.width = "0px";
                h.style.width = "0px";
                if (mini.isChrome || mini.isIE6) {} else {
                    h.parentNode.style.width = "100%";
                    h.parentNode.style.paddingRight = "0px"
                }
            }
        ...
        setTimeout(function() {
            ...
            if (typeof d.setScrollBarPaddingAfterload=='function')
            	d.setScrollBarPaddingAfterload();//王世春
        },
        10)
    },
    setBody: function() {},
    ...
    _createColumnsHTML: function(t, s, r) {
        ...
        g = t.length; m < g; m++) {
            ...
            e = f.length; n < e; n++) {
                ...
                var h = "";
                if (p && p == d.field) {
                    h = c == "asc" ? "mini-grid-asc": "mini-grid-desc"
                }
                q[q.length] = '<td id="';
                q[q.length] = a;
                q[q.length] = '" class="mini-grid-headerCell ' + h + " " + (d.headerCls || "") + " ";
                ...
                q[q.length] = '><div class="mini-grid-headerCell-inner">';
                q[q.length] = o;
                if (h) {
                    q[q.length] = '<span class="mini-grid-sortIcon"></span>'
                }
                q[q.length] = '<div id="' + d._id + '" class="mini-grid-column-splitter"></div>';
                q[q.length] = "</div></td>"
            }
    ...
    _createGroupingHTML: function(g, s) {
        ...
        h = f.length; i < h; i++) {
            ...
            p[p.length] = '<tr id="';
            p[p.length] = d;
            p[p.length] = '" class="mini-grid-groupRow"><td class="mini-grid-groupCell" colspan="';
            p[p.length] = g.length;
    ...
    getBodyHeight: function() {
        var a = mini.GridView.superclass.getBodyHeight.call(this);
    ...
    _OnDrawSummaryCell: function(a, c) {
        ...
        if (c.dataType == "currency1") {
            g.cellHtml = mini.formatCurrencyNew(g.cellHtml, c.currencyUnit)
        }
...
mini.extend(mini.FrozenGridView, mini.GridView, {
    ...
    doUpdateColumns: function() {
        ...
        var e = '<div class="mini-grid-topRightCell"></div>';
        c += e;
        b += e;
    ...
    getLockedWidth: function() {
        ...
        var b = this._rowsLockContentEl.firstChild;
...
mini.extend(mini.ScrollGridView, mini.FrozenGridView, {
    ...
    _getRangeHeight: function(e, b) {
        var a = 0;
        for (var c = e; c < b; c++) {
            var d = this._getScrollRowHeight(c);
            a += d
        }
        return a
    },
    ...
    doUpdateRows: function() {
        ...
        var j = new Date();
        var e = this._createRowsHTML(g, 1, i.rows, i.viewTop, i.viewBottom, h);
        var c = this._createRowsHTML(f, 2, i.rows, i.viewTop, i.viewBottom, h);
    ...
    __OnMouseWheel: function(d) {
        ...
        var c = this.getScrollTop() - a;
        var b = this.getScrollTop();
        this.setScrollTop(c);
        if (b != this.getScrollTop() || this.isVirtualScroll()) {
            d.preventDefault()
        }
    },
...
mini._Grid_Select.prototype = {
    __OnGridKeyDown: function(g) {
        var a = this.owner;
        if (mini.isAncestor(a._filterEl, g.target) || mini.isAncestor(a._summaryEl, g.target) || mini.isAncestor(a._toolbarEl, g.target) || mini.isAncestor(a._footerEl, g.target) || mini.findParent(g.target, "mini-grid-detailRow") || mini.findParent(g.target, "mini-grid-rowEdit")) {
            return
        }
            ...
            if (d.getMultiSelect()) {
                ...
                if (h.htmlEvent.shiftKey) {
                    ...
                    if (h.column._multiRowSelect === true || h.htmlEvent.ctrlKey || d.allowUnselect) {
                    	...
                    	/*2014-03-05 王世春，处理bug：可多选时，单击未选中的行时取消了所有已选中的行。
...
mini._Grid_DragDrop.prototype = {
    ...
    _OnDragStop: function(o) {
        ...
        if (this.isTree) {
            var c = [];
            for (var n = 0,
            f = this.dragData.length; n < f; n++) {
                var q = this.dragData[n];
                var t = false;
                for (var m = 0,
                h = this.dragData.length; m < h; m++) {
...
mini.extend(mini.DataGrid, mini.ScrollGridView, {
    ...
    _OnDrawCell: function() {
        var b = mini.DataGrid.superclass._OnDrawCell.apply(this, arguments);
    ...
    beginEditCell: function(d, c) {
        ...
        if (this._editingCell && a) {
            if (this._editingCell[0] == a[0] && this._editingCell[1] == a[1]) {
                return
            }
        }
        ...
        if (a) {
            var d = a[0],
            c = a[1];
            var b = this._OnCellBeginEdit(d, c, this.getCellEditor(c));
            if (b !== false) {
    ...
    _OnCellBeginEdit: function(b, d, c) {
        ...
        if (!mini.isNull(d.defaultValue) && (mini.isNull(h.value) || h.value === "")) {
        ...
        if (d.displayField && c.setText) {
            ...
            if (!mini.isNull(d.defaultText) && (mini.isNull(i) || i === "")) {
                var g = mini.clone({
                    d: d.defaultText
                });
                i = g.d
    ...
    _OnCellCommitEdit: function(a, d, f, c) {
        var h = {
            sender: this,
            ...
            column: d,
            field: d.field,
            editor: c ? c: this.getCellEditor(d),
        ...
        if (h.cancel == false) {
            if (this.allowCellEdit) {
                var i = {};
                mini._setMap(d.field, h.value, i);
                if (d.displayField) {
                    mini._setMap(d.displayField, h.text, i)
                }
                this.updateRow(a, i)
            }
        }
    ...
    _OnCellShowingEdit: function(d, b) {
        ...
        var c = mini.getViewportBox().width;
        if (i.right > c) {
            i.width = c - i.left;
            if (i.width < 10) {
                i.width = 10
    ...
    _getEditWrap: function(b) {
        ...
        var a = mini.getViewportBox().width;
        if (b.x > a) {
    ...
    getEditRowData: function(t, r) {
        ...
        k = j.length; m < k; m++) {
            ...
            mini._setMap(h.field, p.value, g);
            if (h.displayField) {
                mini._setMap(h.displayField, p.text, g)
            }
        }
        g[a] = t[a];
        if (r) {
    ...
    _createRowDetail: function(e, a) {
        ...
        var b = '<tr id="' + f + '" class="mini-grid-detailRow"><td class="mini-grid-detailCell" colspan="' + g + '"></td></tr>';
        jQuery(c).after(b);
...
mini_DataGrid_CellValidator_Prototype = {
    ...
    validateCell: function(n, c) {
        ...
        if (c.vtype) {
            mini._ValidateVType(c.vtype, h.value, h, c)
        }
        if (h.isValid == true && c.unique && c.field) {
            ...
            d = f.length; g < d; g++) {
                var a = f[g];
                var m = a[k];
                if (mini.isNull(m) || m === "") {} else {
                    var b = j[m];
                    if (b && a == n) {
                        h.isValid = false;
                        h.errorText = mini._getErrorText(c, "uniqueErrorText");
...
mini.extend(mini.TreeGrid, mini.DataGrid, {
    ...
    _createNodeTitle: function(p, b, s) {
        var f = !b;
        if (!b) {
            b = []
        }
        var t = this.isLeaf(p);
        var a = this.getLevel(p);
        var c = s.nodeCls;
        if (!t) {
            c = this.isExpandedNode(p) ? this._expandNodeCls: this._collapseNodeCls
        }
        if (p.enabled === false) {
            c += " mini-disabled"
        }
        ...
        var d = this.getChildNodes(p);
        var q = d && d.length > 0;
        b[b.length] = '<div class="mini-tree-nodetitle ' + c + '" style="' + s.nodeStyle + '">';
        var h = this.getParentNode(p);
        var l = 0;
        for (var r = l; r <= a; r++) {
            if (r == a) {
                continue
            ...
            if (t) {
                if (this.showExpandButtons == false && r >= a - 1) {
                    continue
                }
            }
            var j = "";
            if (this._isInViewLastNode(p, r)) {
                j = "background:none"
            }
            b[b.length] = '<span class="mini-tree-indent " style="' + j + '"></span>'
        }
        var k = "";
        if (this._isViewFirstNode(p) && a == 0) {
            k = "mini-tree-node-ecicon-first"
        } else {
            if (this._isViewLastNode(p)) {
                k = "mini-tree-node-ecicon-last"
            }
        }
        if (this._isViewFirstNode(p) && this._isViewLastNode(p)) {
            k = "mini-tree-node-ecicon-last";
            if (h == this.root) {
                k = "mini-tree-node-ecicon-firstLast"
            }
        }
        if (!t) {
            b[b.length] = '<a class="' + this._eciconCls + " " + k + '" style="' + (this.showExpandButtons ? "": "display:none") + '" href="javascript:void(0);" onclick="return false;" hidefocus></a>'
        } else {
            b[b.length] = '<span class="' + this._eciconCls + " " + k + '" ></span>'
        }
        b[b.length] = '<span class="mini-tree-nodeshow">';
        if (s.showTreeIcon) {
            b[b.length] = '<span class="' + s.iconCls + ' mini-tree-icon"></span>'
        }
        if (s.showCheckBox) {
            var n = this._createCheckNodeId(p);
            var g = this.isCheckedNode(p);
            b[b.length] = '<input type="checkbox" id="' + n + '" class="' + this._checkBoxCls + '" hidefocus ' + (g ? "checked": "") + " " + (p.enabled === false ? "disabled": "") + "/>"
        }
        b[b.length] = '<span class="mini-tree-nodetext">';
        if (this._editingNode == p) {
            var o = this._id + "$edit$" + p._id;
            var m = s.value;
            b[b.length] = '<input id="' + o + '" type="text" class="mini-tree-editinput" value="' + m + '"/>'
        } else {
            b[b.length] = s.cellHtml
        }
        b[b.length] = "</span>";
        b[b.length] = "</span>";
        b[b.length] = "</div>";
        ...
        if (d !== false) {
            ...
            if (g && g.length > 0) {
                ...
                if (f == true) {
                    ...
                    i[i.length] = '<tr class="mini-tree-nodes-tr" style="';
                    if (mini.isIE) {
                        i[i.length] = b
                    }
                    i[i.length] = '" ><td class="mini-tree-nodes-td" colspan="';
                    i[i.length] = e.length;
                    i[i.length] = '" >';
                    i[i.length] = '<div class="mini-tree-nodes" id="';
                    i[i.length] = k;
                    i[i.length] = '" style="';
                    i[i.length] = b;
                    i[i.length] = '">';
    ...
    getAttrs: function(c) {
        ...
        mini._ParseString(c, i, ["value", "url", "idField", "textField", "iconField", "nodesField", "parentField", "valueField", "leafIcon", "folderIcon", "ondrawnode", "onbeforenodeselect", "onnodeselect", "onnodemousedown", "onnodeclick", "onnodedblclick", "onbeforenodecheck", "onnodecheck", "onbeforeexpand", "onexpand", "onbeforecollapse", "oncollapse", "dragGroupName", "dropGroupName", "onendedit", "expandOnLoad", "onbeforedrop", "ondrop", "ongivefeedback", "treeColumn"]);
        mini._ParseBool(c, i, ["allowSelect", "showCheckBox", "showExpandButtons", "showTreeIcon", "showTreeLines", "checkRecursive", "enableHotTrack", "showFolderCheckBox", "resultAsTree", "allowDrag", "allowDrop", "showArrow", "expandOnDblClick", "removeOnCollapse", "autoCheckParent", "loadOnExpand", "expandOnNodeClick"]);
        if (i.expandOnLoad) {
...
mini.regClass(mini.Richtext, "richtext"); (function() {
        ...
        ajaxLoad: function(d) {
            ...
            mini.ajax({
                ...
                success: function(f) {
                    ...
                    top.map[dictTypeId] = mini.encode(e);//cache in top+
                }
            })
        },
        getDictText: function(c, e) {
        	top.map = top.map ||{};//cache in top+
            var d = mini.decode(top.map[c]);//cache in top, original:var d = a.map[c];
            if (d) {
            ...
            mini.ajax({
                ...
                success: function(h) {
                    ...
                    f = a.getDictName(g, e);
                    top.map = top.map ||{};//cache in top+
                    top.map[c] = mini.encode(g);//cache in top+
                }
            });
            return f
        },
            ...
            //if (!d) {
                mini.ajax({
                    ...
                    success: function(f) {
                        ...
                        a.map[c] = e;
                    	top.map = top.map ||{};//cache in top+
                    	top.map[c] = mini.encode(e);//cache in top+
                    }
                });
                d = a.map[c]
            //}
    ...
    a.ajax = function(c) {
        var b = c.url;
        if (b && b.length > 4 && b.indexOf(".ext") == b.length - 4) {
            if (!c.dataType) {
                c.dataType = "json"
            }
            if (!c.contentType) {
    ...
    c.ajax = function(e) {
        var d = e.url;
        if (d && d.length > 4 && d.indexOf(".ext") == d.length - 4) {
            if (!e.dataType) {
                e.dataType = "json"
            }
            if (!e.contentType) {
