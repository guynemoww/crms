...
function save() {
	...
	var modelId="<%=request.getParameter("modelId") %>";
	 var data = {"tbIrmRatingModel":data.tbIrmRatingModel,"oldModelId":modelId};
	var json=nui.encode(data);

	$.ajax({
        url: "com.bos.irm.model.copyModel.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
	...
	nui.get("modelTypeCd").setData(getDictData("XD_PJCD0011","str","C1,C2,C3,C4,C5,C6,C7,C8,C9,C10,F1,F2,F3,F4,F5,P1,P2,P3,S1,S2"));
	</script>
</body>
</html>
