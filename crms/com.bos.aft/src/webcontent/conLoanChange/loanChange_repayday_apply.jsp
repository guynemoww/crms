...
<div id="form" style="width:99.5%;height:auto;overflow:hidden;">
	...
	<fieldset>
	    ...
	    <div class="nui-dynpanel" columns="4" id="table3">
			...
			<label class="nui-form-label">约定扣款日：</label>
			<input id="tbConLoanChange.newRepayDay" class="nui-textbox nui-form-input" name="tbConLoanChange.newRepayDay"
					vtype="int;maxLength:2" required="true"/>
...
<script type="text/javascript">
	...
	function save(){
		...
		if(o.tbConLoanChange.oldRepayDay==o.tbConLoanChange.newRepayDay) {
			return nui.alert("变更后的扣款日不能与变更前相同！");
		}
		
		if(o.tbConLoanChange.newRepayDay>31 || o.tbConLoanChange.newRepayDay<=0) {
			return nui.alert("请按规则填写信息");
		}
