...
<body style="margin-left:10px;">
	...
	<div id="form1" style="width:100%;height:auto;overflow:hidden;">
		...
		<div class="nui-dynpanel" columns="4" style="margin-top:20px;">
		    <label>约见人：</label>
			<input name="apptName"  class="nui-textbox nui-form-input" id="apptName" required="true" style="width:100%;"/>
	...
	function btnSave(){  /* 保存单户检查信息 */
			...
			form.validate();
			var corp = datagrid2.getSelected();
			if(!corp){
			   alert("请选择成员客户！");
			...
			//var param = nui.encode({pfId:param.pfId,partyId:});
			var json = nui.encode({"formData":form.getData(),"rowsData":rows,"param":param,"processInstId":processInstId});
		//	alert(json);
