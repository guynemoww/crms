...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<input type="hidden" name="item._entity" value="com.bos.dataset.sys.TbSysCsmfinawarnParam" class="nui-hidden" />
	<h3>客户财务状况预警参数</h3>
	<div class="nui-dynpanel" columns="4">
		...
		<label>财务自动预警参数:</label>
		<input name="item.financialwarningParameter" required="true" class="nui-dictcombobox nui-form-input" dictTypeId="financialwarningParameter"/>
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto"
	...
	url="com.bos.pub.earlyWarning.csmfinawarnparam.getItemList.biz.ext" dataField="items"
	...
	<div property="columns">
	    ...
	    <div field="financialwarningParameter" headerAlign="center" allowSort="true" dictTypeId="financialwarningParameter">财务自动预警参数</div>
    ...
    <script type="text/javascript">
        ...
        function add() {
            nui.open({
                url: nui.context+"/pub/csmfinaWarningParam/item_add.jsp",
                title: "新增", 
                width: 800, 
            	height: 500,
            	allowResize:true,
        ...
        function editParam() {
            ...
            nui.open({
                url: nui.context+"/pub/csmfinaWarningParam/item_edit.jsp?itemId="+row.csmFinaWarnId,
                title: "参数列表", 
                width: 800,
        		height: 500,
                allowResize:true,
        ...
        function edit(v) {
            ...
            if (row) {
                nui.open({
                    url: nui.context+"/pub/csmfinaWarningParam/item_edit.jsp?itemId="+row.pid+"&view="+v,
                    title: "编辑", 
                    width: 800,
            		height: 500,
                    allowResize:true,
        ...
        function remove() {
            ...
            if (row) {
            	...
            	nui.confirm("确定删除吗？","确认",function(action){
	            	...
	            	var json=nui.encode({"item":{"csmFinaWarnId":
	            		row.csmFinaWarnId}});
	                $.ajax({
	                     url: "com.bos.pub.earlyWarning.csmfinawarnparam.delItem.biz.ext",
		                type: 'POST',
		                data: json,
		                cache: false,
