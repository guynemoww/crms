...
<script type="text/javascript">
	...
	tabs.setTabs([
		...
		{title:"保证人关联信息", url:nui.context+"/crt/con_grt/con_grt_bzr_rel.jsp?subcontractId="+subcontractId+"&applyId="+applyId+"&contractId="+contractId+"&subcontractType=04&view="+view,refreshOnClick:true}
	]);
	$("#tabs").show();
