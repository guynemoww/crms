...
<body>
  ...
  <form id="importForm" action="com.bos.grt.grtImportExcel.ImportTbCar.flow" method="post" enctype="multipart/form-data" >
...
<script type="text/javascript">
	nui.parse();
 	...
 	//下载模板
 	function downExcel(){
 		f.action = "com.bos.grt.grtImportExcel.ImportTbCar.flow?_eosFlowAction=downExcel";
	 	f.submit();
 	}
  /*
  * 功能：导入表内
 ...
 function empImport(){
  	...
  	f.action = "com.bos.grt.grtImportExcel.ImportTbCar.flow?_eosFlowAction=importFile";
  	f.submit();
 }
