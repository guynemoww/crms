...
<body>
	...
	<div class="nui-toolbar" style="border-bottom: 0;">
		...
		<a id="query" class="nui-button" iconCls="icon-zoomin"
			onclick="edit(1)">查看</a> <a id="remove" class="nui-button"
	...
	<div id="grid1" class="nui-datagrid" style="width: 100%; height: auto"
		...
		<div property="columns">
			...
			<div field="financeDeadline" headerAlign="center" allowSort="true"
				dateFormat="yyyy-MM-dd">财务报表日期</div>
			...
			<div field="caliberCd" headerAlign="center" allowSort="true"
				dictTypeId="CDKH0071">财务报表口径</div>
			...
			<div field="auditedInd" headerAlign="center" allowSort="true"
				dictTypeId="XD_ACCD0003">是否经过审计</div>
			<div field="financeStatusCd" headerAlign="center" allowSort="true"
				dictTypeId="XD_ACCCD0004">财务报表状态</div>
			...
			<div field="updateTime" headerAlign="center" allowSort="true"
				dateFormat="yyyy-MM-dd">操作日期</div>
		</div>
	</div>
