...
<div class="nui-fit" style="padding:5px;">
	<div id="listbox1" class="nui-listbox" url="com.bos.pub.product.warrantCode.biz.ext" style="width:370px;height:100%;"
        textField="dictname" valueField="dictid"   multiSelect="true"
       	dataField="eosDictEntrys" showCheckBox="true" showAllCheckBox="false" >
     	<div property="columns">
           <div header="可选担保" field="dictname"></div>
        </div>
    </div>
</div>
