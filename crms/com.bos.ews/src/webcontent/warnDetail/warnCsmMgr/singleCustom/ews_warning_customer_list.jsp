...
<fieldset>
	...
	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;" url="com.bos.ews.queryCsm.querySingleCorp.biz.ext"
	    ...
	    <div property="columns">
	        ...
	        <div field="orgNum" allowSort="true"  headerAlign="center" dictTypeId="org" >所属机构</div>
	        <div field="userNum" allowSort="true"  headerAlign="center" dictTypeId="user" >客户经理</div>       
	    </div>
	</div>
</fieldset>
...
function  addSignalManager(){
  ...
  $.ajax({      
	...
	function  addWarnInfo(){
	  ...
	  //验证：提示列表中是不是有未处理的风险预警
	  var msg = exeRule("REWS_0011","1",json1);
   	    if(null != msg && '' != msg){
   	    	git.unmask();
	   		nui.alert(msg);
	   		return;
