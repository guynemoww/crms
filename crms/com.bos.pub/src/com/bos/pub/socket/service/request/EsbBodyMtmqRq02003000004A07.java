...
/**
 * 
 * @ClassName: EsbBodyMtmqRq02003000004A07
 * @Description: 02003000004信贷信息查询   07逾期借据信息查询
 * 
 */
@XmlRootElement(name = "BODY")
public class EsbBodyMtmqRq02003000004A07 extends EsbBody implements Serializable {
	...
	private String pgRcrdNum;	//每页记录数	String(10)
	private String crnPgNo;	//当前页码	String(10)



	
	
	public EsbBodyMtmqRq02003000004A07() {
