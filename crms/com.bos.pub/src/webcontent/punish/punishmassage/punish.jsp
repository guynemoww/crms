...
<div id="layout1" class="nui-layout" style="width:100%;height:100%;">
	<div title="处罚管理" region="west" width="240" class="sub-sidebar" allowResize="false">
...
<script type="text/javascript">
	...
	var menudata = [
		{id:"处罚管理", text:"处罚管理", //expanded:true, 
			children:[
			{id:"待处罚",text:"待处罚",url:"/pub/punish/punishmassage/punishing.jsp"},
			{id:"已处罚",text:"已处罚",url:"/pub/punish/punishmassage/item_list.jsp"}
			]}
	];
