...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="6">
	    <label>授权机构：</label>
		<input name="tbSysCustGrantList.grantOrgCode" required="false" class="nui-buttonEdit" vtype="maxLength:10" onbuttonclick="selectEmpOrg" />

		<label>担保方式：</label>
		<input name="tbSysCustGrantList.loanType" required="false" class="nui-buttonEdit" vtype="maxLength:2" onbuttonclick="selectCodeList" />
		<label>证件编码：</label>
		<input id="orgn" name="tbSysCustGrantList.orgCode" required="false" class="nui-textbox nui-form-input" vtype="maxLength:10" />
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.sysManagementList.getTbSysCustGrantListList.biz.ext"
	dataField="tbSysCustGrantLists"
	...
	<div property="columns">
		...
		<div field="grantCount" headerAlign="center" allowSort="true" >授权金额</div>
		...
		<div field="currcyCd" headerAlign="center" allowSort="true" dictTypeId="CD000001">币种</div>
		<div field="applyType" headerAlign="center" allowSort="true" dictTypeId="XD_SXCD1039">业务发生性质</div>
		<div field="timeLimit" headerAlign="center" allowSort="true" dictTypeId="XD_SXCD1039">业务期限</div>
 		 <div field="applyCount" headerAlign="center" allowSort="true"   >审批金额</div>
		 <div field="applyDate" headerAlign="center" allowSort="true" dictTypeId="CDKH0002"  >审批日期</div>
		 <div field="endDate" headerAlign="center" allowSort="true" dictTypeId="CDKH0002"  >授信到期日</div>
    ...
    function add() {
        nui.open({
            url: "pub/sysManagementList/custGrantList/custGrant_add.jsp",
            title: "新增", 
            width: 800, 
        	height: 500,
        	allowResize:true,
    ...
    function edit(v) {
        ...
        if (row) {
            nui.open({
                url: "pub/sysManagementList/custGrantList/custGrant_edit.jsp?id="+row.id+"&view="+v,
                title: "编辑", 
                width: 800,
        		height: 500,
                allowResize:true,
    ...
    function remove() {
        ...
        if (row) {
        	nui.confirm("确定删除吗？","确认",function(action){
            	if(action!="ok") return;
            	var json=nui.encode({"tbSysCustGrantList":{"id":
            		row.id,version:row.version}});
                $.ajax({
                     url: "com.bos.pub.sysManagementList.delTbSysCustGrantList.biz.ext",
	                type: 'POST',
	                data: json,
	                cache: false,
	                contentType:'text/json',
