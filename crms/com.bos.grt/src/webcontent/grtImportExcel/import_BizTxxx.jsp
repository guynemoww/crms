...
<body>
		...
		<form id="importForm" action="com.bos.grt.grtImportExcel.ImportBizTxxxApply.flow" method="post" enctype="multipart/form-data" >
  		<input name="amountDetailId" id="amountDetailId" class="nui-hidden" />
...
<script type="text/javascript">
	nui.parse();
 	...
 	//下载模板
 	function downExcel(){
 		f.action = "com.bos.grt.grtImportExcel.ImportBizTxxxApply.flow?_eosFlowAction=downExcel";
	 	f.submit();
 	}
  /*
  * 功能：导入表内
 ...
 function empImport(){
	...
	/* if (contractId) {
  	...
  	f.action = "com.bos.grt.grtImportExcel.ImportBizTxxxApply.flow?_eosFlowAction=importFile";
  	f.submit();
 }
