...
<div id="form" style="width:99.5%;height:auto;overflow:hidden;">
	...
	<fieldset>
	    ...
	    <div class="nui-dynpanel" columns="4" id="table3">
			...
			<label class="nui-form-label">利率调整方式：</label>
			<input id="tbConLoanChange.newIrUpdateFrequency" name="tbConLoanChange.newIrUpdateFrequency" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="XD_SXCD1148"  />
