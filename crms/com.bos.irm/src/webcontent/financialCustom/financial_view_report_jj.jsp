...
<body>
	...
	<div id="form" style="width:100%;height:auto;overflow:hidden;">
		...
		<input id ='party.partyName' name="party.partyName" required="false" enabled='false' class="nui-textarea nui-form-input" vtype="maxLength:100" />
		...
		<input name="corporation.updateOrgNum" required="false" valueField="dictID" dictTypeId="org" class="nui-text nui-form-input" vtype="maxLength:20" />
		...
		<input name="corporation.registerAssets" required="false" class="nui-text nui-form-input" vtype="maxLength:100" />

		<label class="nui-form-label">职工人数(人)：</label>
		<input name="corporation.employeesNumber" required="false" class="nui-text nui-form-input" vtype="maxLength:100" />
		...
		<input name="irmApply.ratingModelVer" required="false" valueField="dictID" dictTypeId="XD_PJCD0011" class="nui-text nui-form-input" vtype="maxLength:20"/>
		
		<label class="nui-form-label">公司成立日期：</label>
		<input name="corporation.registerDate" required="false"  class="nui-text nui-form-input" vtype="maxLength:100" />
		<!-- 	
		...
		<input name=" " required="false" class="nui-hidden"   vtype="maxLength:100"   />  	
		
	        </div> 
 	       
 	         <div colspan="3" align="center"><h4>非财务信息：</h4>
 		        <div id="datagrid2"  class="nui-datagrid"  allowCellEdit="true"  allowCellWrap="true"  showPager="false" style="width:93%;height:auto"
		        	allowCellSelect="true" idField="id" url="com.bos.irm.ratingReportInfo.queryReportNonFincInfo.biz.ext" dataField="nonFinInfoS" editNextOnEnterKey="true" multiSelect="true" >
						...
						<div field="indexOption" name="indexOption" headerAlign="center"   autoEscape="false" width="55%"  >指标选项</div>            
 	        ...
 	        <div colspan="3" align="center"><h4>通用评级调整项信息：</h4>
				<div id="datagrid3" class="nui-datagrid" showPager="false" idField="id" allowCellEdit="true" style="width:93%;height:auto"
			        ...
			        <div property="columns">
				        	...
				        	<div field="adjustOptionDescription" headerAlign="center" allowSort="true" width="60%" headerAlign="center" align="center" >调整事项</div>
    			...
    			<div colspan="3" align="center"><h4>推翻历史：</h4>
