...
<div id="form1" class="nui-form" style="width:99.5%;height:auto;overflow:hidden;">
	<div class="nui-dynpanel" columns="6">
		<input id="item.delWhite" name="item.delWhite" class="nui-hidden nui-form-input"/>
...
<script type="text/javascript">
	...
	var delWhite = "<%=request.getParameter("delWhite") %>" ;
	nui.get('item.delWhite').setValue(delWhite);
    queryInit();
    function queryInit() {
