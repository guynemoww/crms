...
<div id="form1" style="width:100%;height:auto" class="nui-form">
	...
	<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
		url="com.bos.accInfo.accInfo.getAccInfoList.biz.ext"
		dataField="tbConZhs"  allowAlternating="true"
		allowResize="true" showReloadButton="false"
		sizeList="[10,15,20,50,100]" multiSelect="false" pageSize="15" sortMode="client">
		<div property="columns">
			<div type="checkcolumn" >选择</div>
			<div field="zhlx" headerAlign="center"  dictTypeId="XD_SXCD1208" allowSort="true" >账户类型</div>
    ...
    function add() {
        nui.open({
            url: nui.context + "/crt/accountInfo/account_add_db.jsp?contractId=<%=request.getParameter("contractId") %>",
            title: "新增账户", 
            width: 800, 
        	height: 300,
        	allowResize:true,
