...
@Bizlet("getdata")
public class zzrjj_exportXLS {

	@Bizlet("")
	public List<Object> getData(Map[] exldo) {
		//String[] title={"机构名称","客户名称","合同编号","借据编号","贷款品种","业务别","币种","借据金额","借据余额","借据起期","借据止期","贷款利率","借据状态","逾期天数","正常利息","拖欠利息","罚息","经办人"};
		String[] title={"机构名称","客户名称","合同编号","借据编号","贷款品种","币种","借据金额","借据余额","借据起期","借据止期","借据状态","逾期天数","逾期本金","正常利息","拖欠利息","罚息","经办人"};
