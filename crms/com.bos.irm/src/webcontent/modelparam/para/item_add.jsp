...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<label>评级参数类型：</label>
		<input name="tbIrmRatingPara.paraType" required="true" class="nui-dictcombobox nui-form-input" dictTypeId="XD_PJCD0018"  vtype="maxLength:6"/>
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.param.addTbIrmRatingPara.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
