...
<div id="form1" style="width:99.5%;height:auto;overflow:hidden;">
	<input name="sqlName" value="com.bos.csm.natural.natural.relativePsnList" class="nui-hidden" />
...
<div id="datagrid1" class="nui-datagrid" style="width:99.5%;height:auto;"  sortMode="client"
	    ...
	    <div property="columns">
	        ...
	        <div field="appellation" allowSort="true" headerAlign="center" dictTypeId="XD_GLGX0001">关联关系</div>
...
<script type="text/javascript">
	...
	function add() {
            nui.open({
                url:nui.context + "/csm/natural/natural_relative_add.jsp?partyId="+partyId+"&remark="+'02'+"&cType="+cType,
                title: "新增", 
                width: 800, 
            	height: 400,
            	allowResize:true,
	...
	function edit(e) {
       var row = grid.getSelected();
        if (row) {
            nui.open({
                url: nui.context + "/csm/natural/natural_relative_edit.jsp?naturalRelativeId="+row.naturalRelativeId+"&appellation="+row.appellation+"&qote="+e+"&partyId="+partyId+"&partyTypeCd="+row.partyTypeCd+"&certNum="+row.certNum,
                title: "查看编辑", 
                width: 800,
        		height: 400,
                allowResize:true,
