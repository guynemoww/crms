...
<body>
	<div id="form1" style="width:100%;height:auto;overflow:hidden;">
		...
		<input name="tbGrtGuaranteeBasic.userNum" required="true" class="nui-hidden" vtype="maxLength:50" 
			id="tbGrtGuaranteeBasic.userNum" enabled="false" />
		<input name="tbGrtGuaranteeBasic.updateUser" required="true" class="nui-hidden" vtype="maxLength:50"
			id="tbGrtGuaranteeBasic.updateUser" enabled="false" />
		<input name="tbGrtGuaranteeBasic.updateOrg" required="true" class="nui-hidden" vtype="maxLength:10" 
			id="tbGrtGuaranteeBasic.updateOrg" enabled="false" />
		<input name="tbGrtGuaranteeBasic.orgNum" required="true" class="nui-hidden" vtype="maxLength:30"
			id="tbGrtGuaranteeBasic.orgNum" enabled="false" />
		<input name="tbGrtGuaranteeBasic.createTime" required="false" class="nui-hidden" 
			id="tbGrtGuaranteeBasic.createTime" enabled="false" vtype="maxLength:10" />
		<!-- 业务申请所需字段start -->
		...
		<div class="nui-dynpanel" columns="4">
			<label>保证类型：</label>
			<input name="tbGrtGuaranteeBasic.guaranteeType" required="true" class="nui-dictcombobox nui-form-input" 
				id="tbGrtGuaranteeBasic.guaranteeType" dictTypeId="XD_DBCD4001" enabled="false" />
	...
	<script type="text/javascript">
		...
		function save() {
			...
			git.mask();
			$.ajax({
		        url: "com.bos.grt.guaranMainManager.guaranteeApply.addGuaranteeApplyTbGrtGuaranteeBasic.biz.ext",
		        type: 'POST',
		        data: json,
		        cache: false,
		...
		function chooiseParty(){
			nui.open({	
				...
				ondestroy: function (action) {
					...
					//nui.get("tbGrtGuaranteeBasic.guaranteenumber").setValue(action[1]);
