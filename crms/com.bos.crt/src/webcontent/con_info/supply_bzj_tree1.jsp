 			...
 			if(bizType=='01'||bizType=='02'||bizType=='05'){
 				if("01"==contractType){
					...
					menudata[menudata.length]={id:"从合同信息", text:"从合同信息", 
						children:[
							{id:"抵押合同",text:"抵押合同",url:"/crt/con_grt/con_dy_list.jsp?contractId="+contractId+"&subcontractTypeCd=01&applyId="+o.tbBizApprove.applyId+"&contractType=01&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"质押合同",text:"质押合同",url:"/crt/con_grt/con_zy_list.jsp?contractId="+contractId+"&subcontractTypeCd=02&applyId="+o.tbBizApprove.applyId+"&contractType=01&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"保证合同",text:"保证合同",url:"/crt/con_grt/con_bzr_list.jsp?contractId="+contractId+"&subcontractTypeCd=04&applyId="+o.tbBizApprove.applyId+"&contractType=01&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"}
							<%--{id:"保证金协议",text:"保证金协议",url:"/crt/con_grt/con_bzj_list.jsp?contractId="+contractId+"&subcontractTypeCd=03&partyId="+partyId+"&contractType=01&applyId="+o.tbBizApprove.applyId}--%>
					]}
				}
				if("02"==contractType){
	 				menudata = [
					...
					menudata[menudata.length]={id:"从合同信息", text:"从合同信息", 
						children:[
							{id:"抵押合同",text:"抵押合同",url:"/crt/con_grt/con_dy_list.jsp?contractId="+contractId+"&subcontractTypeCd=01&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"质押合同",text:"质押合同",url:"/crt/con_grt/con_zy_list.jsp?contractId="+contractId+"&subcontractTypeCd=02&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"保证合同",text:"保证合同",url:"/crt/con_grt/con_bzr_list.jsp?contractId="+contractId+"&subcontractTypeCd=04&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							/* {id:"追加保证金记录",text:"追加保证金记录",url:"/crt/con_grt/con_bzj_list2.jsp?contractId="+contractId+"&subcontractTypeCd=03&partyId="+partyId+"&contractType=02&applyId="+o.tbBizApprove.applyId+"&proFlag="+proFlag+"&xgbz=1"}, */
							{id:"保证金协议",text:"保证金协议",url:"/crt/con_grt/con_bzj_list1.jsp?contractId="+contractId+"&subcontractTypeCd=03&partyId="+partyId+"&contractType=02&applyId="+o.tbBizApprove.applyId+"&proFlag=1&xgbz=1"}
					]}
				}
				if("03"==contractType){
	 				menudata = [
					...
					menudata[menudata.length]={id:"从合同信息", text:"从合同信息", 
						children:[
							...
							{id:"质押合同",text:"质押合同",url:"/crt/con_grt/con_zy_list.jsp?contractId="+contractId+"&subcontractTypeCd=02&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"保证合同",text:"保证合同",url:"/crt/con_grt/con_bzr_list.jsp?contractId="+contractId+"&subcontractTypeCd=04&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"保证金协议",text:"保证金协议",url:"/crt/con_grt/con_bzj_list.jsp?contractId="+contractId+"&subcontractTypeCd=03&partyId="+partyId+"&contractType=02&applyId="+o.tbBizApprove.applyId+"&proFlag="+proFlag+"&xgbz=1"}
					]}
				}
 			}
				...
				if("02"==contractType){
					...
					menudata[menudata.length]={id:"从合同信息", text:"从合同信息", 
						children:[
							...
							{id:"质押合同",text:"质押合同",url:"/crt/con_grt/con_zy_list.jsp?contractId="+contractId+"&subcontractTypeCd=02&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"保证合同",text:"保证合同",url:"/crt/con_grt/con_bzr_list.jsp?contractId="+contractId+"&subcontractTypeCd=04&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"},
							{id:"保证金协议",text:"保证金协议",url:"/crt/con_grt/con_bzj_list.jsp?contractId="+contractId+"&subcontractTypeCd=03&applyId="+o.tbBizApprove.applyId+"&contractType=02&partyId="+partyId+"&proFlag="+proFlag+"&xgbz=1"}
					]}
				}
 			}
