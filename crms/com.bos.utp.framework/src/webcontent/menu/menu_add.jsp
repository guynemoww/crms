...
<div style="padding-top:0px">
	<div id="form1" method="post">
        ...
        <table style="width:100%;height:auto;table-layout:fixed;" class="nui-form-table" >
            ...
            <tr>
           		<th class="nui-form-label"><label for="acmenu.menuaction$text">功能资源：</label></th>
                <td>
...
<!--                 	<input id="test1" class="nui-buttonedit nui-form-input" onbuttonclick="onButtonEdit" name="acmenu.funccode" textName="test2"/>     -->
                ...
                <td> 
                	<input id="acmenu.isleaf" class="nui-dictcombobox nui-form-input" name="acmenu.isleaf"  required="true"
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            if (o.acmenu.menucode && o.acmenu.funccode && o.acmenu.menucode != o.acmenu.funccode) {
            	alert('选择了功能资源时，菜单代码不能修改！');
            	return;
            }
	        	...
	        	$.ajax({
                    ...
                    success: function (text) {
                       var o = nui.decode(text);
                        if(o.data == "1"){
                        	e.errorText = "菜单代码不唯一，或该菜单已添加，请请重新填写";
	        				e.isValid = false;
                        }
                    }
	           });
