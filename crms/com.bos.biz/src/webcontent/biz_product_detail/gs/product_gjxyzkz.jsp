...
<div id='ht' class="nui-dynpanel" columns="4">
	...
	<label>到期日期：</label>
	<input name="conDetail.dqrq" id="conDetail.dqrq" class="nui-datepicker nui-form-input" required="true" allowInput="false"/>
	<label>开证金额：</label>
	<input id="conDetail.kzje" name="conDetail.kzje" required="true" vtype="float;maxLength:20;range:0,100000000000"  class="nui-textbox nui-form-input" dataType="currency"/>
	<label>溢装比例(%)：</label>
	<input id="conDetail.yzbl" name="conDetail.yzbl"  class="nui-textbox nui-form-input"  vtype="float;maxLength:11;range:0,100" />
	<label>短装比例(%)：</label>
	<input id="conDetail.dzbl" name="conDetail.dzbl" class="nui-textbox nui-form-input" vtype="float;maxLength:11;range:0,100"/>
	<label>保证金账号：</label>
	...
	<label>国内证/国际证：</label>
	<input id="conDetail.gngjz" name="conDetail.gngjz" required="true" data="data" valueField="dictID" class="nui-dictcombobox nui-form-input" dictTypeId="XD_GNJZ0001" emptyText="--请选择--" />
</div>
