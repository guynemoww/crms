...
<title>授信后特定的管理要求</title>
</head>
<body>
<div style="padding: 10px;">
	<div id="form1" style="width:100%;height:auto;overflow:hidden;">
		<div class="nui-dynpanel" columns="2">
			<div colspan="2" style="padding:2px;"><label><span >授信后特定的管理要求:</span></label></div>
			<div colspan="2" style="margin-top:2px"><input class="nui-textarea  nui-form-input" name="specialManageRequire"  id="specialManageRequire" width="100%" height="50px"/></div>
		</div>	
