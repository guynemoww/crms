...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		<label>客户名称：</label>
		<input id="custName" name="tbSysAgreementList.custName" required="true" class="nui-buttonedit nui-form-input" onbuttonclick="onButtonEdit" vtype="maxLength:200" />
		<label>授权机构：</label>
		<input name="tbSysAgreementList.grantOrgCode" required="true" class="nui-buttonEdit" vtype="maxLength:10" onbuttonclick="selectEmpOrg" />
		<label>证件编码：</label>
		<input id="orgn" name="tbSysAgreementList.orgCode" required="false" class="nui-textbox nui-form-input" vtype="maxLength:10" onvalidation="checkOrgnNum"/>
		<label>证件类型：</label>
...
var jsons=nui.encode({"item":{"orgCode":nui.get("orgn").getValue(),"custName":nui.get("custName").getValue(),"_entity":"com.bos.pub.sys.TbSysAgreementList"}});
	$.ajax({
        ...
        success: function (text) {
        	if(text.msg){
        		...
        		return;
							...
							$.ajax({
						        url: "com.bos.pub.sysManagementList.addTbSysAgreementList.biz.ext",
						        type: 'POST',
						        data: json,
						        cache: false,
						        contentType:'text/json',
