...
<div id="form1" style="width:99.5%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<label>关联客户类型：</label>
		<input id="rela.custType"name="rela.custType" required="true" enabled="false"  class="nui-dictcombobox"  dictTypeId="CDKH0034" onvaluechanged="clearControlInfo"/>
		...
		<label>证件类型：</label>
		<input id="rela.certType" name="rela.certType" enabled="false" class="nui-dictcombobox" dictTypeId="CDKH0002" />
		<label>证件号码：</label>
