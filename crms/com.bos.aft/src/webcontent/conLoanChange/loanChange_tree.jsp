...
<script type="text/javascript">
	...
	if("06"==loanChangeType || "19"==loanChangeType){//期限变更
		menudata = [
			{id:"贷后变更信息", text:"贷后变更信息",
				children:[
					{id:"变更信息",text:"变更信息",url:"/aft/conLoanChange/loanChange_term_apply.jsp?changeId="+changeId+"&proFlag="+proFlag+"&loanChangeType="+loanChangeType}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
