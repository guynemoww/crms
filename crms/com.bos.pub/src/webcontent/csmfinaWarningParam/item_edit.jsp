...
<div class="nui-toolbar" style="border-bottom:0;text-align:center;">
  ...
  function update(){
	    ...
	    <!-- form.validate();   --> 
	       ...
	       $.ajax({
	       	   url:"com.bos.pub.earlyWarning.csmfinawarnparam.updateTbSysCsmcreditwarnParam.biz.ext",
	       	   type:'POST',
	       	   data:json,
...
function initForm() {
	...
	var json=nui.encode({"item":{"csmFinaWarnId":"<%=request.getParameter("itemId") %>"}});
		
	$.ajax({
            url: "com.bos.pub.earlyWarning.csmfinawarnparam.getItem.biz.ext",
            type: 'POST',
            data: json,
            cache: false,
            contentType:'text/json',
