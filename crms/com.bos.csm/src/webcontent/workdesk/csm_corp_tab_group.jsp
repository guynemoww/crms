...
<script type="text/javascript">
	...
	<%String partyNum = request.getParameter("partyNum"); %>
		...
		tabs.setTabs([
			{title:"客户信息", url:nui.context+"/csm/company/groupCompany_tree.jsp?partyId=<%=corpid %>&qote=1&partyNum=<%=partyNum %>", showCloseButton:false},
			...
			{title:"额度信息", url:nui.context+"/crd/crd_apply/crd_apply_jt.jsp?corpid=<%=corpid %>",refreshOnClick:true},
