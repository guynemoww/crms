...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<input type="hidden" name="item" class="nui-hidden" /><input type="hidden" name="item._entity" value="com.bos.dataset.sys.TbSysWarnCorpCreBalance" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"item":{"corpCreditBalanceId":"<%=request.getParameter("itemId") %>",
		"_entity":"com.bos.dataset.sys.TbSysWarnCorpCreBalance"}});
	$.ajax({
        url: "com.bos.pub.TbSysWarnCorpCreBalance.getItem.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.pub.TbSysWarnCorpCreBalance.saveItem.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
