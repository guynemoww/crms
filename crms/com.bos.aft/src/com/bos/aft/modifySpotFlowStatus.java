...
public class modifySpotFlowStatus implements IBIZProcess {
	...
	public void executeAfterCreateFlow(String processInstId, Map workitem) throws EOSException
	{
    	...
    	try {
    		List<Object> list = RelativeDataManagerService.getRelativeDataBatch(Long.valueOf(processInstId), xpath);
				//获取申请记录id
				String sidId=list.get(0).toString();
				int status=1;
				//Object[] result = null;
				// 逻辑构件名称             
				String componentName = "com.bos.aft.aft_spot_inspect";
				// 逻辑流名称 
				String operationName = "modifySpotFlowStatus";
