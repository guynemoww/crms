 ...
 * <ul>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgid <em>Orgid</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgcode <em>Orgcode</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgname <em>Orgname</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrglevel <em>Orglevel</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgdegree <em>Orgdegree</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgseq <em>Orgseq</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgtype <em>Orgtype</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgaddr <em>Orgaddr</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getZipcode <em>Zipcode</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getManaposition <em>Manaposition</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getManagerid <em>Managerid</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOrgmanager <em>Orgmanager</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getLinkman <em>Linkman</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getLinktel <em>Linktel</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getWeburl <em>Weburl</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getStartdate <em>Startdate</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getEnddate <em>Enddate</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getArea <em>Area</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getCreatetime <em>Createtime</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getLastupdate <em>Lastupdate</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getUpdator <em>Updator</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getSortno <em>Sortno</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getIsleaf <em>Isleaf</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getSubcount <em>Subcount</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getRemark <em>Remark</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getBuno <em>Buno</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getAuditbankno <em>Auditbankno</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getPaymentsysno <em>Paymentsysno</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getParentorgcode <em>Parentorgcode</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getIsteam <em>Isteam</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getIsTradeArea <em>IsTradeArea</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrganizationImpl#getOmOrganization <em>OmOrganization</em>}</li>
 * </ul>
 * </p>
 *
...
public class OmOrganizationImpl extends ExtendedDataObjectImpl implements OmOrganization {
	...
	public final static int INDEX_BUNO = 27;
	public final static int INDEX_AUDITBANKNO = 28;
	public final static int INDEX_PAYMENTSYSNO = 29;
	public final static int INDEX_PARENTORGCODE = 30;
	public final static int INDEX_ISTEAM = 31;
	public final static int INDEX_ISTRADEAREA = 32;
	public final static int INDEX_OMORGANIZATION = 33;
	...
	public String getIsTradeArea() {
		return DataUtil.toString(super.getByIndex(INDEX_ISTRADEAREA, true));
	}

	/**
	 * Sets the value of the '{@link com.primeton.eos.Test#getIsTradeArea <em>IsTradeArea</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setIsTradeArea(String isTradeArea) {
		super.setByIndex(INDEX_ISTRADEAREA, isTradeArea);
	}
