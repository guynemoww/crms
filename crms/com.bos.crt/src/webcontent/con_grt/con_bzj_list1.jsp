...
<script type="text/javascript">
	...
	function view(){
		nui.open({
            url: nui.context+"/crt/con_grt/con_bzj_list2.jsp?contractId="+contractId+"&subcontractTypeCd=03&partyId="+partyId+"&contractType=02&applyId="+applyId+"&proFlag="+proFlag+"&xgbz=1",
            showMaxButton: true,
            title: "保证金追加历史记录",
            width: 800,
            height: 500,
