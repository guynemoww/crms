...
<body>
<div style="margin-top:30px;">预警管理->预警预案复核</div>  
...
<div id="warrant" class="nui-datagrid" style="width:100%;height:auto" url="com.bos.ews.warnPlan.getCsmWarrantInfo.biz.ext" dataField="csmWarrants"
	allowResize="true" showReloadButton="false" showPageSize="false" pageSize="5" multiSelect="false" sortMode="client">
     ...
     <div field="creditTotalAmount" headerAlign="center" allowSort="true" dictTypeId="XD_YJCD0001"> 现有银行授信合计 </div>
     <div field="totalMoney" headerAlign="center" allowSort="true"> 现有对外担保合计 </div>
     </div>
</div>
...
<div class="nui-toolbar" style="border-bottom:0;text-align:center;margin-top: 50px;">
...
<script type="text/javascript">
      nui.parse();
	    ...
	    var planBizId = "<%=request.getParameter("planBizId") %>"; //获取流程载体数据
...
function save(){
    ...
    var json=nui.encode({"warnPlan":warnPlan,planBizId:planBizId});
    $.ajax({
            url: "com.bos.ews.warnPlan.updateWarnPlan.biz.ext",
            type: 'POST',
            data: json,
            cache: false,
            contentType:'text/json',
