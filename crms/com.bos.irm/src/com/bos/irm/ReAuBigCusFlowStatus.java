...
public class ReAuBigCusFlowStatus implements IBIZProcess {
    ...
    public void executeBeforeTerminate(String processInstId, Map workitem) throws EOSException{
    	...
    	try {
    		List<Object> fg = RelativeDataManagerService.getRelativeDataBatch(Long.valueOf(processInstId), xpath);
				...
				String bizType=fg.get(1).toString();
					
				// 逻辑构件名称             
				String componentName = "com.bos.irm.irm_rating_work";
				// 逻辑流名称 
				String operationName = "addRatingResultInfo1";//添加评级结果数据
				ILogicComponent logicComponent = LogicComponentFactory.create(componentName);
                //逻辑流的输入参数
...
//		Map<String,String> relaDatas = new HashMap<String,String>();
//		relaDatas.put("isConfirmPer","" );
//		relaDatas.put("isReAud","" );
//		relaDatas.put("isTrustworthy","" );
//		try {
//			BpsResultString ret = FlowService.setRelativeDataBatch("", processInstId, relaDatas);
//			if(null != ret.getErrCode() && !"".equals(ret.getErrCode())){
//				throw new EOSException(ret.getErrCode(),ret.getErrInfo());
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
