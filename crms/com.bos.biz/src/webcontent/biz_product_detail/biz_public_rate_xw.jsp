...
<div class="nui-dynpanel" columns="4"  id="tableloanrate">		
	...
	<input name="loanrate.rateType" id="loanrate.rateType" enabled="false"class="nui-dictcombobox nui-form-input" dictTypeId="XD_SXCD1016" required="true" onvaluechanged="onselectType"/>

	<label id="floatWay">浮动方式：</label>
	<input name="loanrate.floatWay" class="nui-dictcombobox nui-form-input" enabled="false"dictTypeId="XD_SXCD1147" id="loanrate.floatWay" required="true"/>
	...
	<input id="loanrate.yearRate" name="loanrate.yearRate" class="nui-textbox nui-form-input" vtype="float;maxLength:11;range:0.00000001,100" required="true" onblur="onYearrate"/>
	
	<label id="isChangeRate">利率调整方式：</label>
	<input id="loanrate.irUpdateFrequency"  enabled="false"name="loanrate.irUpdateFrequency" class="nui-dictcombobox nui-form-input" required="true" dictTypeId="XD_SXCD1148"  />
			
	<label id="jxzq">结息周期：</label>
	<input name="loanrate.interestCollectType" class="nui-dictcombobox nui-form-input" enabled="false"dictTypeId="XD_SXCD1018" id="loanrate.interestCollectType" required="true" />
	
	<label id="jjrsybz">节假日顺延标志：</label>
	<input name="loanrate.holidayFlg" id="loanrate.holidayFlg"enabled="false" data="data" valueField="dictID" class="nui-dictcombobox nui-form-input" dictTypeId="XD_0002"  onvaluechanged="conChangeHoliday" required="true"/>
	...
	<input id="loanrate.overdueRateUpProportion" name="loanrate.overdueRateUpProportion" class="nui-text nui-form-input"  vtype="int;maxLength:11;range:30,50" required="true" value="50"/>
