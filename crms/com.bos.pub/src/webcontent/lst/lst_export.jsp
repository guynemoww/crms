...
if(ret != null && !"".equals(ret)){
 ...
 %>
<form id="form1" action="com.bos.lst.lstManage.flow" method="post"  enctype="multipart/form-data" >
	<div class="nui-dynpanel"  columns="2">
		<label>监控名单Excel导入：</label>
...
<script type="text/javascript">
	...
	//导出模板
 	function downExcel(){
 		 ...
 		 f.action = "com.bos.lst.lstManage.flow?_eosFlowAction=downExcel";
		 f.submit();
 	}
 	...
 	function uploadExcel(){
	  ...
	  {
		   nui.alert('请选择格式为：[.xls]的Excel文档！'); //请选择Excel文件！
		   return;
	  }
	  //增加遮罩
	  git.mask();
	  excelFile = excelFile.substr(excelFile.lastIndexOf("\\") + 1);
	  f.action = "com.bos.lst.lstManage.flow?_eosFlowAction=importFile";
	  f.submit();
