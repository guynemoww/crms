...
<body>
<center>
<fieldset><legend> <span>业务启用列表</span> </legend>
...
<%--		<div class="nui-dynpanel" columns="6">
		...
		<div class="nui-toolbar" >
			<a class="nui-button" id="btnCreate" onclick="update">启用</a>
		</div>
		<div id="grid" class="nui-datagrid"   sortMode="client"
		    url="com.bos.bizApply.bizApply.getApplyQyBizInfo.biz.ext" dataField="bizInfos"
		    ...
		    <div property="columns">
		        ...
		        <div field="CREDIT_AVI" allowSort="true" width="" headerAlign="center">可用金额</div>
...
<script type="text/javascript">
	...
	function update(){
		...
		var json=nui.encode({"approveId":row.APPROVE_ID,"bizHappenType":"09"});
		$.ajax({
