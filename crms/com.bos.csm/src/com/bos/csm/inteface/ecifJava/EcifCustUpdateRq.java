...
public class EcifCustUpdateRq extends SuperBosfxRq{
...
//	四部委企业规模-人工输入
	...
	//地址
	@XmlElement(name="C201OrgCusEcifRec")
	public List<AddressInfo> AddressList;
	
	//其他地址
	@XmlElement(name="NetAddrRec")
	public List<AddressInfo2> AddressList2;
	...
	public void setCNShortName(String shortName) {
		CNShortName = shortName;
	}
	...
	public void setAddressList2(List<AddressInfo2> addressList2) {
