...
<form id="form1" action="" method="post" class="nui-form" style="height:auto;overflow:hidden;">
	<div class="nui-dynpanel" columns="4">
		<label>保单编号：</label>
		<input name="map/policyNum" required="false" class="nui-textbox nui-form-input"  />
		<label>贷款人名称：</label>
	...
	<div id="grid1" class="nui-datagrid" style="width:99.65%;height:auto;margin-top:1px"
		url="com.bos.grt.marnmanage.marnmanage.tbGrtSafeexpire.biz.ext"
		dataField="safe"
		...
		<div property="columns">
			...
			<div field="policyNum" headerAlign="center" allowSort="true">保单编号</div>
			<div field="startDate" headerAlign="center" allowSort="true">保单起始日期</div>
			<div field="dueDate" headerAlign="center" allowSort="true">保单到期日期</div>
