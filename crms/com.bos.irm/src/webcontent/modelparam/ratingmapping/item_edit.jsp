...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%--   --%><input type="hidden" name="tbIrmRatingMapping" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"tbIrmRatingMapping":
		{"ratingMappingId":
		"<%=request.getParameter("ratingMappingId") %>"}});
	$.ajax({
        url: "com.bos.irm.param.getTbIrmRatingMapping.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.param.updateTbIrmRatingMapping.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
