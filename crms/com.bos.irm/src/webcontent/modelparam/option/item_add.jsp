...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%-- #{hiddenData} --%>
	<input type="hidden" name="tbIrmAdjustOption.modelNumber"  value="<%=request.getParameter("modelId") %>"   class="nui-hidden"  />
	<div class="nui-dynpanel" columns="4">
		...
		<label>调整级别：</label>
		<input name="tbIrmAdjustOption.adjustSeries" id="adjustSeries" required="true" class="nui-textbox nui-form-input"  vtype="int:0,16" onvaluechanged="adjustSeriesChanged" />
		...
		<label>适用模型编号：</label>
		<input name="tbIrmAdjustOption.modelNumber" required="false" allowInput="false" class="nui-buttonEdit" onbuttonclick="selectModel" />
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.model.addTbIrmAdjustOption.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
