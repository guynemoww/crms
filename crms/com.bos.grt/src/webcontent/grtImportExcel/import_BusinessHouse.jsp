...
<title>房地产--商业用房</title>
<body>
</head>
  <form id="importForm" action="com.bos.grt.grtImportExcel.ImportBusinessHouse.flow" method="post" enctype="multipart/form-data" >
  	...
  	<div class="nui-toolbar" style="border-bottom:0;padding-right:20px;text-align:right;">
  		...
  		<a class="nui-button"  onclick="down"/>下载行政区划编码</a>
...
<script type="text/javascript">
	nui.parse();
 	...
 	//下载模板
 	function downExcel(){
 		f.action = "com.bos.grt.grtImportExcel.ImportBusinessHouse.flow?_eosFlowAction=downExcel";
	 	f.submit();
 	}
 	//下载行政区划编码
 	function down(){
 		f.action = "com.bos.grt.grtImportExcel.ImportBusinessHouse.flow?_eosFlowAction=down";
	 	f.submit();
 	}
  /*
  * 功能：导入表内
 ...
 function empImport(){
  	...
  	f.action = "com.bos.grt.grtImportExcel.ImportBusinessHouse.flow?_eosFlowAction=importFile";
  	f.submit();
 }
