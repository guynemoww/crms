...
<script type="text/javascript">
	...
	var menudata = [
		{id:"填写客户相关信息", text:"填写客户相关信息", //expanded:true, 
			children:[
			{id:"基本情况",text:"基本情况",url:"/aft/dailyInspect/basicCondition.jsp?callback=y&param="+param},
			{id:"经营情况",text:"经营情况",url:"/aft/dailyInspect/operateCondition.jsp?callback=y&param="+param},
			{id:"财务情况",text:"财务情况",url:"/aft/dailyInspect/financeCondition.jsp?callback=y&param="+param},
			{id:"信用与还款意愿",text:"信用与还款意愿",url:"/aft/dailyInspect/creditCondition.jsp?callback=y&param="+param},
			{id:"外部环境与重大事项",text:"外部环境与重大事项",url:"/aft/dailyInspect/externalFactor.jsp?callback=y&param="+param},
			{id:"客户情况",text:"客户情况",url:"/aft/dailyInspect/basicMessage.jsp?param="+param},
			{id:"检查报告",text:"检查报告",url:"/aft/dailyInspect/inspectReport.jsp?param="+param}
