...
/**
 * 
 * @ClassName: EsbBodyEcifRs12002000013A01 
 * @Description: 12002000013客户信息开户维护		01个人客户基本信息开户
 *
 */
@XmlRootElement(name = "BODY")
public class EsbBodyEcifRs12002000013A01 extends EsbBody implements Serializable {
	private static final long serialVersionUID = 1L;

	private String cstNo;			//客户代号			String(10)		
	private String cstNm;			//客户名称			String(50)		
	private String formrNm;			//曾用名			String(20)		
	...
	private String hshdRgstKnd;		//户籍性质			String(19)		
	private String birthDate;		//出生日期			String(8)		
	private String ntntyCd;			//国籍代码			String(3)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String cstImptLvlCd;	//客户重要级别代码	String(3)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String bnkStkhdFlg;		//本行股东标志		String(3)		"1是0否-1未知"
	private String bnkSnrMgrFlg;	//本行高管标志		String(3)		"1是0否-1未知"
	private String marriageCd;		//婚姻状况代码		String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String hltSt;			//健康状况			String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String religion;		//宗教信仰			String(6)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String highEdct;		//最高学历			String(4)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String hsTp;			//住宅类型			String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String prsnTaxNo;		//个人纳税号		String(64)		
	private String prsnScilScrNo;	//个人社保号		String(64)		
	private String strtWrkDate;		//参加工作年份		String(8)		
	private String ocpCd;			//职业代码			String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String coNm;			//单位名称			String(100)		
	private String coKnd;			//单位性质			String(5)		
	private String coWrkTrm;		//现单位工作年限		String(2)		
	...
	private String wrkBnkStfLvl;	//在行职员等级		String(19)		
	private String posTtlCd;		//职称代码			String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private double incmAmt;			//月收入金额		Double(20,2)		
	private String mainEcnmSrcDsc;	//主要经济来源		String(120)		
	private String othrEcnmSrcDsc;	//其他经济来源		String(120)		
	private String lngTp;			//语种			String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String grdtSchNm;		//毕业院校			String(20)		
	private String mjrNm;			//专业			String(20)		
	private String grdtDt;			//毕业年月			String(6)		
	private String dgrCd;			//学位代码			String(5)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String rsdntFlg;		//居民标志			String(1)		"1是0否"
	private String lclRsdntTm;		//本地居住时间		String(2)
	private String rcrdSt;			//记录状态			String(4)		见绵阳银行ESB项目_JJCCBBSD_代码列表
	private String atchInstNo;		//归属机构号		String(16)
	private String fmSysInd;		//来源系统标志		String(10)	信贷系统：300050	见绵阳银行ESB项目_JJCCBBSD_代码列表
	...
	public EsbBodyEcifRs12002000013A01(){
