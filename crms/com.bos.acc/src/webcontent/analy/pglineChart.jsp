...
<script type="text/javascript"
	src="<%=contextPath %>/acc/analy/js/jquery.min.js"></script>
<script type="text/javascript"
	src="<%=contextPath %>/acc/analy/js/highcharts.src.js"></script>
<script type="text/javascript"
	src="<%=contextPath %>/acc/analy/js/exporting.js"></script>
<script type="text/javascript">
...
<body>
	<div
		style="width: 98%; height: auto; overflow: hidden; text-align: center; margin-top: 20px; border: 1px solid black">
		<fieldset>
			<legend>
				<span>分析图</span>
			</legend>
			<div id="container"
				style="width: 98%; height: auto; overflow: hidden; text-align: center; margin-top: 20px; border: 1px solid black"></div>
		</fieldset>
		<br />
		<br />
		<br />
		...
		<fieldset>
			...
			<div id="list"
				...
				<iframe
					src="<%=contextPath%>/acc/analy/analysis/biz_public_info.jsp?finanysisProgramId=<%=request.getParameter("finanysisProgramId")%>&moduleId=<%=request.getParameter("moduleId")%>"
					style="width: 98%; height: auto;"> </iframe>
			</div>
		</fieldset>
