...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<input name="oldUserNum" id="oldUserNum" required="true"  class="nui-buttonEdit" onbuttonclick="selectCustManeger" />
 		...
 		<label>变更后所在机构：</label> 
 		<input id="newOrgNum" name="newOrgNum" required="true" class="nui-buttonEdit" onbuttonclick="selectEmpOrgs" vtype="maxLength:32" />
...
<script type="text/javascript">
	...
	function save() {
		...
		if (newOrgNum == oldOrgNum && oldUserNum == newUserNum) {
			...
			nui.confirm("全部移交会将原客户经理下有管护权的客户全部移交，确认吗？",
							"客户移交提醒",
							function(action) {
								if (action == "ok") {
									git.mask("form1");
