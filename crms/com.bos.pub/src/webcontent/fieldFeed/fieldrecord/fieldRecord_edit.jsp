...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%--   --%><input type="hidden" name="tbPubFieldRecord" class="nui-hidden" />
			<input name="tbPubFieldRecord.dataRecordId"  class="nui-hidden"  />
...
function initForm() {
	var json=nui.encode({"tbPubFieldRecord":
		{"dataRecordId":
		"<%=request.getParameter("dataRecordId") %>"}});
	$.ajax({
        url: "com.bos.pub.fieldflefeed.getTbPubFieldRecord.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.pub.fieldflefeed.updateTbPubFieldRecord.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
