...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.standingbook.entrustedloan.GetImportCreditList.biz.ext"
	dataField="items"
	...
	<div property="columns" >
		...
		<div field="availableAmt" headerAlign="center" allowSort="true" >合同已用金额</div>
		<div field="loanApplyNo" headerAlign="center" allowSort="true" >放款申请编号</div>
		<div field="bcurrencyCd" headerAlign="center" allowSort="true"  dictTypeId="CD000001">本次放款币种</div>
		<div field="loanAmt" headerAlign="center" allowSort="true" dataType="currency">本次放款金额</div>
		<div field="startDate" headerAlign="center" allowSort="true" >本次放款起始日</div>
		<div field="expirationDate" headerAlign="center" allowSort="true" >本次放款到期日</div>
		...
		<div field="invoiceNum" headerAlign="center" allowSort="true" >发票号</div>
		<div field="invoiceCurrency" headerAlign="center" allowSort="true"  dictTypeId="CD000001">发票币种</div>
    ...
    function exportEmp()
    {
		...
		if(rows != null && rows.length > 0) {
	     var form = document.getElementById("form1");
			     form.action = "com.bos.pub.standingbook.accountManager.flow?_eosFlowAction=exportFile&importCd=219";
			     form.submit();
	    }
	    else{
	    nui.alert("没有要导出的记录");
