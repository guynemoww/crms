...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<div class="nui-dynpanel" columns="4">
		<label>规则名称：</label>
		<input class="nui-textbox nui-form-input" name="rule.ruleName" vtype="maxLength:50" required="true" enabled="true"/>
...
<!-- <table style="width:100%;height:auto;table-layout:fixed;" class="nui-form-table">
						<tr>
							<td class="nui-form-label">规则名称：</td>
							<td>
<input class="nui-textbox nui-form-input" name="rule.ruleName" vtype="maxLength:50" required="true"/>
					        </td>
							<td class="nui-form-label">规则描述：</td>
							<td>
<input class="nui-textbox nui-form-input" name="rule.ruleDesc" vtype="maxLength:500" required="false"/>
					        </td>
...
<input class="nui-textbox nui-form-input" name="rule.ruleParam" vtype="maxLength:1000" required="false"/>
						...
						<tr>
					        <td class="nui-form-label">嵌套引用的规则列表（逗号分隔）:</td>
							<td>
<input class="nui-textbox nui-form-input" name="rule.ruleRuleInd" vtype="maxLength:1000" required="false"/>
					        </td>
					        <td class="nui-form-label">规则表达式:</td>
							<td colspan="3">
<input class="nui-textarea nui-form-input" name="rule.ruleExpr" required="true" style="width:300px;"/>
					        </td>
						</tr>
					</table>-->
</div>
...
function save() {
	...
	var o=form.getData();
	o.rule.ruleInd=o.rule.ruleName;
	o.rule.ruleStatus="0";
	o.rule.ruleClass="1";//参数分类：1-评级模型使用。此字段暂无含义
	var json=nui.encode(o);
	//nui.alert(json);
	$.ajax({
            url: "com.bos.pub.model.rule.addRule.biz.ext",
            type: 'POST',
            data: json,
            cache: false,
