...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<div class="nui-dynpanel" columns="4">
		...
		<label>主键ID：</label>
		<input name="tbWfmBusiparameter.paraId" required="false" enabled="false" class="nui-textbox nui-form-input" vtype="maxLength:18" />
...
function initForm() {
	var json=nui.encode({"tbWfmBusiparameter":
		{"workitemMappingId":
		"<%=request.getParameter("workitemMappingId") %>","paraId":"<%=request.getParameter("paraId") %>"}});
	$.ajax({
        url: "com.bos.bps.util.TbWfmBusiparameters.queryTbWfmBusiparametersSingle.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.bps.util.TbWfmBusiparameters.saveTbWfmBusiparameters.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
