...
<script type="text/javascript">
    ...
    targeName = ["warrantManInfo","mortgage"];
...
//显示选项卡
	function initGrid(e) {
		...
		var ogj = $(IdName);
		//$('#aliDataIdDiv').html('');
		var pageJsonData=nui.encode({"fileName":"targetConfig.xml","pageName":targeName,"alcInfoId":alcInfoId,lastAlcInfoId:lastAlcInfoId,show:2});
		$.ajax({//获取页面选项卡集indexResults
