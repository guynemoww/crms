 ...
 */
public class ResponseA208 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5395336548982491156L;
	private String FIRST_NO_COM;//起始笔数
	private String RESULT_SIZE_COM;//查询笔数
	private String ALL_RESULT_SIZE_COM;//总笔数
	...
	/**
	 * @return aLL_RESULT_SIZE_COM
	 */
	public String getALL_RESULT_SIZE_COM() {
		return ALL_RESULT_SIZE_COM;
	}
	/**
	 * @param aLL_RESULT_SIZE_COM 要设置的 aLL_RESULT_SIZE_COM
	 */
	public void setALL_RESULT_SIZE_COM(String aLL_RESULT_SIZE_COM) {
		ALL_RESULT_SIZE_COM = aLL_RESULT_SIZE_COM;
	}
	/**
	 * @return eCIF_CUST_NO
	 */
