...
<title>大宗商品--化工导入</title>
<body>
</head>
  <form id="importForm" action="com.bos.grt.grtImportExcel.ImportChemicalIndustr.flow" method="post" enctype="multipart/form-data" >
...
<script type="text/javascript">
	nui.parse();
 	...
 	//下载模板
 	function downExcel(){
 		f.action = "com.bos.grt.grtImportExcel.ImportChemicalIndustr.flow?_eosFlowAction=downExcel";
	 	f.submit();
 	}
  /*
  * 功能：导入表内
 ...
 function empImport(){
  	...
  	f.action = "com.bos.grt.grtImportExcel.ImportChemicalIndustr.flow?_eosFlowAction=importFile";
  	f.submit();
 }
