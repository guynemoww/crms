...
<body>
	...
	<div id="listbox1" class="nui-listbox" url="com.bos.irm.param.getDictData.biz.ext?dicttypeid=XD_PJCD0011" style="width:388px;height:100%;"
          multiSelect="true"  textField="DICTNAME" idField="DICTID"
       	dataField="dictList" showCheckBox="true">
     	<div property="columns">
           <div header="可用模型" field="DICTNAME"></div>
        </div>
    </div>
