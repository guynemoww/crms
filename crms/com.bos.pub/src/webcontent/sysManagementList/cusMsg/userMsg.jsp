...
<div id="form1" style="width:50%;height:auto;overflow:hidden;" >
		<div class="nui-dynpanel" columns="2">
			<label>所属机构：</label>
			<input id="teamItem.orgId" name="teamItem.orgCode" allowInput="false" class="nui-buttonEdit" onbuttonclick="selectEmpOrg" value="<%=request.getParameter("oldOrgNum") %>" dictTypeId="org" enabled="false"/>
		</div>
</div>
</div>
