      ...
      menudata = [
		{id:"预警级别认定审核", text:"预警级别认定审核",                                                   //expanded:true, 
			children:[
				...
				{id:"预警级别认定",text:"预警级别认定",url:"/ews/warnDetail/warnLevel/ews_warnLevel_hold.jsp?bizId=<%=request.getParameter("bizId") %>&processInstId=<%=request.getParameter("processInstId") %>&onlyRead=1"},
