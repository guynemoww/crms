...
<div class="nui-fit" style="padding:5px;">
	<div id="listbox1" class="nui-listbox" url="com.bos.pub.repPower.getRepPowerMenu.biz.ext" style="width:388px;height:100%;"
        textField="MENU_NAME" valueField="MENU_ID"   multiSelect="true"
       	dataField="reps" showCheckBox="true" showAllCheckBox="false" >
     	<div property="columns">
           <div header="报表权限" field="MENU_NAME"></div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
	...
	function GetData() {
		...
		for(var i=0;i<items.length;i++){
			ids.push(items[i].MENU_ID);
			texts.push(items[i].MENU_NAME);
		}
