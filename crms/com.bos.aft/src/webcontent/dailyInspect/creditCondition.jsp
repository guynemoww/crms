...
<body>
	...
	<input name="pageName" id="pageName" class="nui-hidden" value="creditConditionPage"/>
...
<script type="text/javascript">
	...
	function reLoad(){
  	 var url;
	 if(goEdit=="1"){
	   url=nui.context+"/aft/dailyInspect/creditCondition.jsp?param="+nui.encode(param)+"&callback="+callback+"&getFirst=2";
	 }else{
	   url=nui.context+"/aft/dailyInspect/creditCondition.jsp?param="+nui.encode(param)+"&callback="+callback+"&getFirst=1";
	 }
	 git.go(url);
	}
