...
public class CommReqTranHeader {
	public String HPinSeed;// PIN种子
	public String HOriChnl;// 源渠道
	public String HSecFlag;// 安全标志
	public String HPwdFlag;// 加密标志
	public String HCombFlag;// 组合标志
	public String HSvcInfo;// 服务信息
	public String HSecInfoVerNo;// 安全信息版本号
	public String HSysChnl;// 渠道号
	public String HLegaObj;// 责任承担者
	public String HMsgRefNo;// 消息参考号
	public String HTermNo;// 终端号
	public String HCityCd;// 城市代码
	public String HBrchNo;// 发送方机构ID
	public String HUserID;// 服务请求者
	public String HTxnCd;// 交易代码
	public String HTxnMod;// 交易模式
	public String HReserveLen;// 保留数量字段
	public String HSenderSvcCd;// 发起端服务码
	public String HSenderSeq;// 发起端流水
	public String HSenderDate;// 发起端日期
	public String HAuthUserID;// 授权服务请求者
	public String HAuthVerfInfo;// 授权验证信息
	public String HAuthFlag;// 授权标志
	public String HRefSeq;// 关联流水
	public String HAuthSeri;// 授权序号
	public String HHostSeq;// 核心流水号
	public String HRefDt;// 关联日期
	public String HSvcVer;// 服务版本号
	public String HreserveMsg;// 保留信息字段
