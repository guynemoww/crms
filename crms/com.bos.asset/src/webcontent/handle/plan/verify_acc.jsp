	...
	<div id="tabs1" class="nui-tabs" activeIndex="0" style="width: 100%; height: 100%;">
		<div title="处置方案">
			<div id="form1" class="nui-form">
				<input name="sqlName" class="nui-hidden" value="com.bos.asset.handle.plan.VerifyOffSql.verifyAcc" />
			...
			<div class="nui-fit">
				<div id="gridLoan" class="nui-datagrid" style="height: 100%" url="com.bos.pub.dao.search.biz.ext" dataField="items" multiSelect="false" sortMode="client" allowAlternating="true">
					<div property="columns">
						...
						<div field="CANCEL_CAPITAL_AMT" allowSort="true" headerAlign="center">核销本金</div>
						<div field="CANCEL_NORMAL_ITR" allowSort="true" headerAlign="center">核销正常利息</div>
						<div field="CANCEL_ARREAR_ITR" allowSort="true" headerAlign="center">核销拖欠利息</div>
						<div field="CANCEL_PUNISH_ITR" allowSort="true" headerAlign="center">核销罚息</div>
						<div field="CANCEL_AMT" allowSort="true" headerAlign="center">核销总额</div>
						<div field="PURSUE" allowSort="true" headerAlign="center" dictTypeId="XD_0002">是否保留追索权</div>
