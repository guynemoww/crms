 ...
 * 
 */
public class AddWhiteAction extends AProcessAction {
	...
	public ProcessParam action(String bizId) {
		...
		if(DictContents.ORG_MCCB.equals(legorg)){
			param.setTemplateName("biz_apply_bmdzr_mccb");
		}else if(DictContents.ORG_BCFM.equals(legorg)){
			param.setTemplateName("biz_apply_bmdzr_bcfm");
		}else if(DictContents.ORG_PWFM.equals(legorg)){
			param.setTemplateName("biz_apply_bmdzr_pwfm");
		}
		return param;
	}
