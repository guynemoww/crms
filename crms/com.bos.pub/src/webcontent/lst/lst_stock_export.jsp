...
if(ret != null && !"".equals(ret)){
 ...
 %>
<form id="form1" action="com.bos.lst.lstStock.flow" method="post"  enctype="multipart/form-data" >
...
<script type="text/javascript">
	...
	//导出模板
 	function downExcel(){
 		 ...
 		 f.action = "com.bos.lst.lstStock.flow?_eosFlowAction=downExcel";
		 f.submit();
 	}
 	...
 	function uploadExcel(){
	  ...
	  f.action = "com.bos.lst.lstStock.flow?_eosFlowAction=importFile";
	  f.submit();
