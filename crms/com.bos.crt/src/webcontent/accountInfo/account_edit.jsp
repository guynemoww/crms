...
<div id="form1" style="width:96%;height:auto;overflow:hidden; text-align:center;margin: 10px;"  class="nui-form">
	<input type="hidden" name="tbConAccountInfo" class="nui-hidden" />
	<div class="nui-dynpanel" columns="4">
				...
				<label>账户开户网点号：</label>
				<input id="zhkhjg" name="tbConZh.zhkhjg" required="true"  class="nui-textbox nui-form-input"  />
					
				<label>账户开户行名称：</label>
				<input id="zhkhhmc"  name="tbConZh.zhkhhmc" required="true"  class="nui-textbox nui-form-input" />
