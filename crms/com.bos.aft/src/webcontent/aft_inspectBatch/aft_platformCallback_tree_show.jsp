...
<script type="text/javascript">
   nui.parse();
   var pfId="<%=request.getParameter("bizId") %>";
	var queryParam={"pfId":pfId};
    var parentPfId;
    var partyId;
    var json={"pfId":pfId};
     nui.ajax({
    ...
    document.getElementById("exportFrame2").src=nui.context+"/aft/aft_small_inspect/aft_link_info_url.jsp?partyId="+partyId;
     var param={"pfId":pfId,"partyId":partyId};
     var parentParam=nui.encode({"pfId":parentPfId,"partyId":partyId});
     param=nui.encode(param);	
	var menudata = [
		{id:"贷后检查", text:"贷后检查", //expanded:true, 
			children:[
				{id:"平台客户情况",text:"平台客户情况",url:"/aft/aft_inspectBatch/aft_platformCorpInfo.jsp?param="+parentParam+"&callback=y"},
				{id:"平台综合情况",text:"平台综合情况",url:"/aft/aft_inspectBatch/aft_pfComprehensiveInfo_edit.jsp?param="+param+"&callback=y"},
				{id:"平台单户检查",text:"平台单户检查",url:"/aft/aft_inspectBatch/aft_pfCBDetailInfo_show.jsp?param="+param+"&callback=y"}
				//{id:"意见",text:"意见",url:"/aft/aft_inspectBatch/aft_pfCBIdea_show.jsp?param="+param}
			]},
