...
import com.bos.utp.dataset.organization.OmOrgPosiEmp;
 ...
 * <ul>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getInorgid <em>Inorgid</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getInorgname <em>Inorgname</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getOrglevel <em>Orglevel</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getOrgseq <em>Orgseq</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getEmpid <em>Empid</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getEmpcode <em>Empcode</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getEmpname <em>Empname</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getEmpstatus <em>Empstatus</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getOperatorid <em>Operatorid</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getUserid <em>Userid</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getOperatorname <em>Operatorname</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getPositionseq <em>Positionseq</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getPosicode <em>Posicode</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getPosiname <em>Posiname</em>}</li>
 *   <li>{@link com.bos.utp.dataset.organization.impl.OmOrgPosiEmpImpl#getOrgcode <em>Orgcode</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements OmOrgPosiEmp;
 */

public class OmOrgPosiEmpImpl extends ExtendedDataObjectImpl implements OmOrgPosiEmp {
	/**
	...
	public final static int INDEX_ORGCODE = 16;
	 ...
	 * <!-- end-user-doc -->
	 */
	public OmOrgPosiEmpImpl(Type type) {
		super(type);
	}
