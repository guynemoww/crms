...
<div id="form1" style="width:100%;height:auto" class="nui-form">
	...
	<div id="gridpj" class="nui-datagrid" style="width:100%;height:auto" 
		url="com.bos.pay.pjxx.queryTxxxs.biz.ext" dataField="hps"
...
<script type="text/javascript">	
	...
	function view(v){
	    ...
	    if (row) {
	        nui.open({
	            url: nui.context+"/biz/biz_product_detail/pjxx/biz_tx_edit.jsp?applyDetailId="+row.applyDetailId+"&view="+1,
	            title: "查看票据信息", 
	            width: 800,
	    		height: 500,
	            allowResize:true,
