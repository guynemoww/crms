...
<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;"  sortMode="client"
	    url="com.bos.grt.grtMainMargin.grtPublic.queryPartyList.biz.ext" dataField="items"
	    ...
	    <div property="columns">
	        ...
	        <div field="partyName" allowSort="true"  width="20%"headerAlign="center" >客户名称</div> 
	       	<div field="unifySocietyCreditNum"name="unifySocietyCreditNum"  headerAlign="center" >统一社会信用代码</div> 
...
<div style="width:99.5%">
    ...
    <a class="nui-button"  iconCls="icon-ok" onclick="selected()">确认</a>
	</div>
</div>
...
<script type="text/javascript">
    ...
    function selected() {
    	...
    	if(partyTypeCd=='01'){
    		...
    		if(null==row.middleCode){
    			alert("中征码为空的抵质押人不允许新增,请更改!");
    			return;
    		}
    	}else{
