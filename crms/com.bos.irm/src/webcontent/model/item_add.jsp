...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%-- #{hiddenData} --%>
	<input type="hidden" name="tbIrmRatingModel.modelState"  value="1"   class="nui-hidden"  />
	<div class="nui-dynpanel" columns="4">
		<label>模型类型：</label>
		<input name="tbIrmRatingModel.modelTypeCd" id="modelTypeCd" required="true" class="nui-dictcombobox nui-form-input" dictTypeId="XD_PJCD0011" vtype="maxLength:6" />
		
		<!--<label>模型版本：</label>
		<input name="tbIrmRatingModel.ratingModelVer" required="true" class="nui-textbox nui-form-input" vtype="maxLength:6" />-->

		<label>模型名称：</label>
		<input name="tbIrmRatingModel.modelName" id="tbIrmRatingModel.modelName" required="true"  class="nui-textbox nui-form-input"  vtype="maxLength:20" />
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.model.addTbIrmRatingModel.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
	...
	nui.get("modelTypeCd").setData(getDictData("XD_PJCD0011","str","M1,M2,M3,M4,M5,P1,P2,S1,S2,S3,S4,S5,C1,T1"));
	</script>
</body>
</html>
