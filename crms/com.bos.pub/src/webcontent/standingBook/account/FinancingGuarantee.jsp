...
<!-- 
			...
			<label>发票号：</label>
			<input name="map/invoiceNum"  required="false"  class="nui-textbox nui-form-input" vtype="maxLength:32" />
			<label>放款金额：</label>
			<div>
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.standingbook.entrustedloan.GetFinancingGuaranteeList.biz.ext"
	dataField="items"
	allowResize="true" showReloadButton="false"
	sizeList="[10,15,20,50,100]" multiSelect="false" pageSize="15" sortMode="client">
	<div property="columns" >
		<div type="checkcolumn" >选择</div>
		<div field="" headerAlign="center" allowSort="true" >编号</div>	
		...
		<div field="guaranteeBenefitName" headerAlign="center" allowSort="true" >受益人名称</div>
		<div field="issuedCurrency" headerAlign="center" allowSort="true" dictTypeId="CD000001">保函币种</div>
		<div field="guarantyOccupyMoney" headerAlign="center" allowSort="true"  dataType="currency">担保项下债务金额（原币）</div>
		<div field="usdguarantyOccupyMoney" headerAlign="center" allowSort="true"  dataType="currency">担保项下债务金额（折美元）</div>
		<div field="" headerAlign="center" allowSort="true" >质押形式</div>
		<div field="gcurrencyCd" headerAlign="center" allowSort="true" dictTypeId="CD000001">保证金币种</div>
		<div field="accBalance" headerAlign="center" allowSort="true"  dataType="currency">保证金金额（原币种）</div>
		<div field="poundageRatio" headerAlign="center" allowSort="true"  dataType="currency">手续费比例</div>
		<div field="issuedDate" headerAlign="center" allowSort="true" dateformat="yyyy-MM-dd">开立日期</div>
		<div field="endTime" headerAlign="center" allowSort="true" dateformat="yyyy-MM-dd">到期日</div>
    ...
    function exportEmp()
    {
		...
		if(rows != null && rows.length > 0) {
	     var form = document.getElementById("form1");
			     form.action = "com.bos.pub.standingbook.accountManager.flow?_eosFlowAction=exportFile&importCd=220";
			     form.submit();
	    }
	    else{
	    nui.alert("没有要导出的记录");
