...
function addCsm(){
  git.mask();
  var url=nui.context+"/ews/warnDetail/monitor/ews_new_warrantCsm_list.jsp?monitor=1&type=06";
  git.go(url);              
}       
...
function viewInfo(){
   ...
   return;
     ...
     var url= nui.context+ "/ews/warnDetail/warnInfo/ews_warnInfo_monitor_add.jsp?corpid="+row.partyId+"&type=06&partyName="+row.partyName+"&partyNum="+row.partyNum;
     git.go(url);        
