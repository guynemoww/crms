...
<center>
 <form id="form1" action="" method="post" enctype="multipart/form-data" >
	<div class="nui-dynpanel" columns="6">
			...
			<label>放款申请编号：</label>
			<input name="map/loanApplyNo" required="false" id="laidend" class="nui-textbox nui-form-input" vtype="maxLength:32" onbuttonclick="selectProduct"/>
			...
			<label>放款到期日：</label>
			<div>
			<input name="map/expirationDate1" id="removestart" required="false" class="nui-datepicker nui-form-input" onvaluechanged="onregDueDate1"/>~
			<input name="map/expirationDate2" id="removeend" required="false" class="nui-datepicker nui-form-input" onvaluechanged="onDueDate1"/>
			</div>					
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.standingbook.entrustedloan.GetForfaitingList.biz.ext"
	dataField="items"
	...
	<div property="columns" >
		...
		<div field="occupiedAmt" headerAlign="center" allowSort="true"  dataType="currency">累计放款金额</div>	
		<div field="availableAmt" headerAlign="center" allowSort="true"  dataType="currency">合同已用金额</div>
		<div field="loanApplyNo" headerAlign="center" allowSort="true" >放款申请编号</div>	
		...
		<div field="startDate" headerAlign="center" allowSort="true" >放款起始日</div>	
		<div field="expirationDate" headerAlign="center" allowSort="true" >放款到期日</div>
		<div field="lcNo" headerAlign="center" allowSort="true" >信用证编号</div>	
		<div field="negotiationZmountCurrency" headerAlign="center" allowSort="true"  dictTypeId="CD000001">议付币种</div>	
		<div field="negotiationAmount" headerAlign="center" allowSort="true"  dataType="currency">议付金额</div>
		<div field="issuingBank" headerAlign="center" allowSort="true" >开证银行</div>
		<div field="rateFloatMember" headerAlign="center" allowSort="true"  dataType="currency">利率浮动点数</div>		
    ...
    function exportEmp()
    {
		...
		if(rows != null && rows.length > 0) {
	     var form = document.getElementById("form1");
			     form.action = "com.bos.pub.standingbook.accountManager.flow?_eosFlowAction=exportFile&importCd=217";
			     form.submit();
	    }
	    else{
	    nui.alert("没有要导出的记录");
