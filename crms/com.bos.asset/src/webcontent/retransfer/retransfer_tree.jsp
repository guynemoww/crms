...
<body>
	<div id="layout" class="nui-layout" style="width: 100%; height: 100%;">
		<div title="不良资产逆移交" region="west" width="240" class="sub-sidebar" allowResize="false">
	...
	<%=JspUtil.getParameterHaveSign(request, "processInstId")%>
		...
		function initMenu() {
			...
			menudata[menudata.length] = {
				id : "逆移交信息",
				text : "逆移交信息",
				url : "/asset/retransfer/retransfer_edit.jsp?retransferId="
						+ bizId + "&edit=" + edit
			};
			menudata[menudata.length] = {
				id : "借据清单",
				text : "借据清单",
				url : "/asset/retransfer/loanInfo_list.jsp?retransferId=" + bizId
						+ "&edit=2"
			};
			if (wflow == "2") {
				menudata[menudata.length] = {
