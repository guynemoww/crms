...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<input type="hidden" name="item" class="nui-hidden" /><input type="hidden" name="item._entity" value="com.bos.dataset.sys.TbSysWarnSecurityValue" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"item":{"securityValueId":"<%=request.getParameter("itemId") %>",
		"_entity":"com.bos.dataset.sys.TbSysWarnSecurityValue"}});
	$.ajax({
        url: "com.bos.pub.TbSysWarnSecurityValue.getItem.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.pub.TbSysWarnSecurityValue.saveItem.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
