...
<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;"  sortMode="client"
	    url="com.bos.csm.thirdParty.thirdParty.queryThirdPartyForBusi.biz.ext" dataField="items"
...
<script type="text/javascript">
	...
	nui.parse();
	var thirdCustTypeCd="<%=request.getParameter("thirdCustTypeCd")%>";
	nui.get("item.thirdCustTypeCd").setValue(thirdCustTypeCd);
	// 传递进来的股东类型作为隐藏参数
