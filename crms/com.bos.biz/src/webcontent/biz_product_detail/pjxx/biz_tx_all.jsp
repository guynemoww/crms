...
<script type="text/javascript">
	...
	init();
	function init(){
		var json = nui.decode({"amountDetailId":amountDetailId,"contractNum":contractNum}); 
		DataGrid.load(json);
	}
	...
	function add_zp(){
	    ...
	    nui.open({
	        url: nui.context + "/biz/biz_product_detail/pjxx/biz_tx_add_zp.jsp?amountDetailId="+amountDetailId+"&partyId="+partyId+"&ecifPartyNum="+ecifPartyNum+"&productType="+productType+"&contractId="+contractId,
	        title: "新增纸票信息", 
	        width: 1000, 
	    	height: 500,
	    	allowResize:true,
	...
	function add_dp(){
		...
		nui.open({
			url: nui.context + "/biz/biz_product_detail/pjxx/biz_tx_add_dp.jsp?amountDetailId="+amountDetailId+"&partyId="+partyId+"&ecifPartyNum="+ecifPartyNum+"&productType="+productType+"&contractId="+contractId,
			title: "新增电票信息", 
			width: 1000, 
			height: 500,
			allowResize:true,
