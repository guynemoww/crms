...
<script type="text/javascript">
	...
	var normalCheckId ="<%=request.getParameter("normalCheckId") %>"; //日常检查主键
	var checkType ="<%=request.getParameter("checkType") %>"; //检查分类
	...
	var json = nui.encode({partyId:partyId,checkId:normalCheckId,flag:"2"});
	 /* $.ajax({
        ...
        $.ajax({
            ...
            success: function (mydata) { 
            	...
            	checkNum = o.tbAftNormalCheck.checkNum;
            	party = o.tbCsmParty;
            	checkType = o.tbAftNormalCheck.checkType;
            },
            error: function (jqXHR, textStatus, errorThrown) {
                    alert(jqXHR.responseText);
            }
	...
	if("01"==checkType){//个人贷款后跟踪检查表
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_track_person.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("02"==checkType){//贷款后跟踪检查表（房地产项目贷款）
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_track_house.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("10"==checkType){//个人经营类日常检查报告
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_normal_person.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("08"==checkType){//项目贷款类企业日常检查报告
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_normal_project.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("03"==checkType){//贷款后跟踪检查表（贸易型企业）
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_track_trade.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("04"==checkType){//贷款后跟踪检查表（生产型企业）
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_track_product.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("05"==checkType){//贷款后跟踪检查表（学校、医院贷款）
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_track_schhos.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("06"==checkType){//贸易型企业日常检查报告
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_normal_trade.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("07"==checkType){//生产型企业日常检查报告
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_normal_product.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	}
	if("09"==checkType){//委托贷款类日常检查报告
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_normal_trust.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
...
if("11"==checkType){//个人消费类日常检查报告
		menudata = [
			{id:"日常检查内容", text:"日常检查内容",
				children:[
					{id:"检查内容",text:"检查内容",url:"/aft/normalCheck/normalCheck_apply_normal_person_xf.jsp?normalCheckId="+normalCheckId+"&proFlag="+proFlag}
				]
			},
			{id:"影像资料", text:"影像资料", children:view}
		];
	...
	//意见提交
	if("-1"!=proFlag){
		menudata[menudata.length]={id:"意见",text:"意见",url:"/com.bos.bps.service.workFlowAdvice.flow?bizId=<%=request.getParameter("normalCheckId") %>&processInstId=<%=request.getParameter("processInstId")%>&isSrc=2"};
	} 
	...
	function checkBeforeSub(){
		...
		if("10"==checkType){
			var json = {"normalCheckId":normalCheckId};
			msg = exeRule("RAFT_0003","1",json);
			if(null != msg && '' != msg){
		   		nui.alert(msg);
		   		return "1";
   	    	}
