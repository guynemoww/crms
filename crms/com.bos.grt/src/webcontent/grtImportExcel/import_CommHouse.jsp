...
<body>
  ...
  <form id="importForm" action="com.bos.grt.grtImportExcel.ImportHouse.flow" method="post" enctype="multipart/form-data" >
...
<script type="text/javascript">
	nui.parse();
 	...
 	//下载模板
 	function downExcel(){
 		f.action = "com.bos.grt.grtImportExcel.ImportHouse.flow?_eosFlowAction=downExcel";
	 	f.submit();
 	}
 	//下载行政区编码
 	function down(){
 		f.action = "com.bos.grt.grtImportExcel.ImportHouse.flow?_eosFlowAction=down";
	 	f.submit();
 	}
  /*
  * 功能：导入表内
 ...
 function empImport(){
  	...
  	f.action = "com.bos.grt.grtImportExcel.ImportHouse.flow?_eosFlowAction=importFile";
  	f.submit();
 }
