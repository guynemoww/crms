...
<body>
<strong>说明：客户存在未结清专业贷款时按需填写。</strong>
	...
	<input name="pageName" id="pageName" class="nui-hidden" value="projectDeviation"/>
...
<script type="text/javascript">
	...
	function reLoad(){
	 var url;
	 if(goEdit=="1"){
	   url=nui.context+"/aft/dailyInspect/loanCondition.jsp?param="+nui.encode(param)+"&callback="+callback+"&getFirst=2";
	 }else{
	   url=nui.context+"/aft/dailyInspect/loanCondition.jsp?param="+nui.encode(param)+"&callback="+callback+"&getFirst=1";
	 }
	 git.go(url);
	}
       ...
       if (form.isValid()==false){
		...
		for(var i=0;i<=num;i++) {//遍历选项卡
			...
			*/
			...
			if(result==1){
			if((newData1 == null || newData1 == '' || newData1 == undefined)||(commentText == null || commentText == '' || commentText == undefined)){
