...
<body>
	<div style="padding-top:0px">
		<div id="form1">
			<div >
	         ...
	         <table style="width:100%;height:20%;table-layout:fixed;" class="nui-form-table" >
	            <tr>
    ...
    <script type="text/javascript">
        ...
        var json = nui.encode({template:{funcgroupid:funcgroupid}});
		    $.ajax({
		        url: "com.bos.utp.framework.FuncGroupManager.getFuncGroup.biz.ext",
		        type: 'POST',
		        data: json,
		        cache: false,
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "com.bos.utp.framework.FuncGroupManager.updateFuncGroup.biz.ext",
                type: 'POST',
                data: json,
                cache: false,
                contentType:'text/json',
