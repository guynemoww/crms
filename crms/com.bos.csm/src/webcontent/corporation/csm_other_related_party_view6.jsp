...
<div id="form1" style="width:99.5%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<label>证件类型：</label>
		<input id="rela.certType" name="rela.certType" enabled="false" class="nui-dictcombobox nui-form-input" dictTypeId="XD_ZJLX0001" enabled="false" />
		
		<label>证件号码：</label>
		<input id="rela.certNum" name="rela.certNum" enabled="false"="true" class="nui-textbox nui-form-input" enabled="false"/>

		<label>关联关系：</label>
		<input id="rela.relatedCd" name="rela.relatedCd" required="true" class="nui-buttonEdit nui-form-input" allowInput="false"dictTypeId="XD_GLGX0003" enabled="false" />
