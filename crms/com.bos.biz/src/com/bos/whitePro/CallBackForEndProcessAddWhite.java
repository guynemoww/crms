 ...
 * 
 * */
public class CallBackForEndProcessAddWhite implements IBIZProcess {
	
	public static TraceLogger logger = new TraceLogger(CallBackForEndProcessAddWhite.class);
			...
			if(applyId!=null&&!"".equals(applyId)){
				...
				if(whites!=null){
					for (DataObject dataObject : whites) {
						...
						if("03".equals(cusStatus)){
						dataObject.set("cusStatus", "02");
