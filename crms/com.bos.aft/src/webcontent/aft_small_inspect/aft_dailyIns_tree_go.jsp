...
<script type="text/javascript">
	...
	var menudata = [
		{id:"填写客户相关信息", text:"填写客户相关信息", //expanded:true, 
			...
			{id:"检查报告",text:"检查报告",url:"/aft/dailyInspect/newSmlCheckReport.jsp?partyId="+partyId+"&node="+nui.encode(node)+"&bizId="+smId}
			]},
		//{id:"检查意见",text:"检查意见",url:url},
		{id:"相关文档",text:"相关文档",
			children:[
					...
					{id:"文档管理",text:"文档管理",url:"/aft/file/relevantFile.jsp?applyId="+smId+"&button=1"+"&corpType=1"+"&processInstId=<%=request.getParameter("processInstId") %>"+"&party="+nui.encode(party)}
			]}
