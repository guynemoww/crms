...
<body>
		<div id="form1" style="width: 99.5%; height: auto; overflow: hidden;">
			<fieldset>
				...
				<input name="item.accId" id="item.accId" class="nui-hidden" />
				<div class="nui-dynpanel" columns="4">
					<label>账户名称：</label> <input id="item.accName" name="item.accName"
						required="true" class="nui-textbox nui-form-input"  enabled="false"/>
	...
	initForm();
	function initForm() {
		var json=nui.encode({"accId":accId});
			$.ajax({
		...
		if(flag == "1"){
			...
			var o = form.getData();
			o.item._entity="com.bos.dataset.csm.TbCsmEntrustAccount";
