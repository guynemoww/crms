...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%--   --%><input type="hidden" name="tbIrmPermisionsConfig" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"tbIrmPermisionsConfig":
		{"permissionsConfigId":
		"<%=request.getParameter("permissionsConfigId") %>"}});
	$.ajax({
        url: "com.bos.irm.param.getTbIrmPermisionsConfig.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.param.updateTbIrmPermisionsConfig.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
