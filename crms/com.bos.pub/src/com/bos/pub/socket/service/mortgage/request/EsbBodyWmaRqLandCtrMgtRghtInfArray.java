...
/**
 * 
 * @ClassName: EsbBodyWmaRqLandCtrMgtRghtInfArray   土地承包经营
 * @Description: 02002000004信贷信息维护		02押品信息建立	
 *
 */
@XmlRootElement(name = "PlgDtlInf")
public class EsbBodyWmaRqLandCtrMgtRghtInfArray implements Serializable {
	private static final long serialVersionUID = 1L;
	
	private  String ctrMgtPrsnNm;          			//承包经营权人名称               	    String(80)       Y
	private  String landCtrMgtRghtCtfNo;			//土地承包经营权证号       	        String(20)       Y
	...
	private  String landTfrFeePymtSt;				//土地出让金缴纳状态                                    String(4)        Y
	
	public EsbBodyWmaRqLandCtrMgtRghtInfArray(){
	...
	public String getLandCtrMgtRghtCtfNo() {
		return landCtrMgtRghtCtfNo;
	}

	@XmlElement(name = "LandCtrMgtRghtCtfNo")
	public void setLandCtrMgtRghtCtfNo(String landCtrMgtRghtCtfNo) {
		this.landCtrMgtRghtCtfNo = landCtrMgtRghtCtfNo;
	}
	...
	public String getLandTfrFeePymtSt() {
		return landTfrFeePymtSt;
	}

	@XmlElement(name = "LandTfrFeePymtSt")
	public void setLandTfrFeePymtSt(String landTfrFeePymtSt) {
		this.landTfrFeePymtSt = landTfrFeePymtSt;
	}
