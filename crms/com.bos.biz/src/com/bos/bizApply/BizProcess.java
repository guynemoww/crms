...
public class BizProcess {
	public static TraceLogger logger = new TraceLogger(BizProcess.class);
	...
	private void setPartyInfoToRelaMap(ProcessParam param) {
		...
		param.putRelaMap("cusName", party.get("partyName"));
		param.putRelaMap("custId", party.get("partyNum"));
	}
}
