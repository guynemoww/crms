...
<form id="form1" action="" method="post" class="nui-form" style="height:auto;overflow:hidden;">
	<div class="nui-dynpanel" columns="4">
		<label>担保合同号：</label>
		<input name="map/subcontractNum" required="false" class="nui-textbox nui-form-input"  />
		<label>贷款人名称：</label>
	...
	<div id="grid1" class="nui-datagrid" style="width:99.65%;height:auto;margin-top:1px"
		url="com.bos.grt.marnmanage.marnmanage.tbGrtCardrevert.biz.ext"
		dataField="card"
		...
		<div property="columns">
			...
			<div field="sotckRemovalDate" headerAlign="center" allowSort="true">权证借出日期</div>
			<div field="cardInRevertDate" headerAlign="center" allowSort="true">权证预归还日期</div>
			<div field="stockRemovalReason" headerAlign="center" allowSort="true">权证借出原因</div>
