...
<body>
		...
		<div id="form1">
	    	<table style="width:100%;height:98%;table-layout:fixed;" class="nui-form-table" >
	            ...
	            <tr>
	                ...
	                <td colspan="3">                        
	                    <input id="appapplication.url" name="appapplication.url" class="nui-textbox nui-form-input" onblur="querySQL"style="width:420px;" onvalidation="urlvalidation"/>
	                </td>
	            </tr>
	            <tr class="odd">
    ...
    <script type="text/javascript">
      ...
      function querySQL(){
      	if(nui.get("appapplication.appdesc").getValue()=="sQl"){
      	         nui.open({
                url: "<%=request.getContextPath() %>/pub/log/function_sql.jsp",
                title: "应用配置查询", 
                width: 1000, 
            	height: 600,
            	allowResize:false,
