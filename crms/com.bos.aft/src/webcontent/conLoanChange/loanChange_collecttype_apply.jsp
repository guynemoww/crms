...
<div id="form" style="width:99.5%;height:auto;overflow:hidden;">
	...
	<fieldset>
	    ...
	    <div class="nui-dynpanel" columns="4" id="table3">
			...
			<label class="nui-form-label">结息周期：</label>
			<input id="tbConLoanChange.newInterestCollectType" name="tbConLoanChange.newInterestCollectType" required="true" 
					class="nui-dictcombobox nui-form-input" dictTypeId="XD_SXCD1018"  />
