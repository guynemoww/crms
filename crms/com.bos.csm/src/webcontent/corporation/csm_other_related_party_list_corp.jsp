...
<div id="form1" style="width:99.5%;height:auto;overflow:hidden;">
	<input type="hidden" name="sqlName" value="com.bos.csm.corporation.tbCsmRelatedInfo.otherRelatedPartyListCorp" class="nui-hidden" />
...
<div id="grid1" class="nui-datagrid" style="width:99.5%;height:auto" 
	...
	<div property="columns">
		...
		<div field="certType" headerAlign="center" allowSort="true" dictTypeId="XD_ZJLX0002" >证件类型</div>
		...
		<div field="relatedCd" headerAlign="center" allowSort="true" dictTypeId="XD_GLGX0004">关联关系</div>
    ...
    function search() {
		if (partyId) {
		   ...
		   var json = nui.encode({"ecifPartyNum":ecifPartyNum,"partyId":partyId});
		    $.ajax({
         url: "com.bos.csm.pub.ibatis.corpgetItemEcifRelCorp.biz.ext",
         type: 'POST',
         data: json,
         cache: false,
         async:false,
...
//         nui.alert(data.map.msgg);
    ...
    function add() {
        nui.open({
            url: nui.context + "/csm/corporation/csm_other_related_party_corp_add.jsp?partyId="+partyId,
            title: "新增", 
            width: 850, 
        	height: 480,
        	allowResize:true,
    ...
    function edit(v) {
        ...
        if (row) {
        	if('0' == v){
        	        		url = nui.context + "/csm/corporation/csm_other_related_party_edit.jsp?itemId="+row.otherRelatedPartyId+"&qote="+v+"&custType="+row.custType;
