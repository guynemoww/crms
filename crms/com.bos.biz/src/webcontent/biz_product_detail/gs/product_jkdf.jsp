...
<div id='ht' class="nui-dynpanel"  columns="4" style="width:99.5%;">
	...
	<label>产品类型：</label>
	<input id="conDetail.cplx" name="conDetail.cplx" required="true" valueField="dictID" class="nui-dictcombobox nui-form-input" dictTypeId="XD_JKDFLX0001" emptyText="--请选择--" />
</div>
