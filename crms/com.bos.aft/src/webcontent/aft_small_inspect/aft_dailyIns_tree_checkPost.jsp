...
<script type="text/javascript">
	...
	var menudata = [
		{id:"填写客户相关信息", text:"填写客户相关信息", //expanded:true, 
			children:[
			{id:"检查信息",text:"检查信息",url:"/aft/aft_small_inspect/dailyInspect_add.jsp?param="+param+"&callback=y"},
			{id:"检查报告",text:"检查报告",url:"/aft/dailyInspect/newSmlCheckReport.jsp?partyId="+partyId+"&bizId="+smId+"&processInstId=<%=request.getParameter("processInstId") %>&score=1"+"&onlyRead=1"}
			]},
		{id:"相关文档",text:"相关文档",
			children:[
