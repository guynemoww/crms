...
<title>房地产--车库车位(有独立产证)</title>
<body>
</head>
  <form id="importForm" action="com.bos.grt.grtImportExcel.ImportRealestate.flow" method="post" enctype="multipart/form-data" >
  	...
  	<div class="nui-toolbar" style="border-bottom:0;padding-right:20px;text-align:right;">
  		...
  		<a class="nui-button"  onclick="down"/>下载行政区域编码</a>
...
<script type="text/javascript">
	nui.parse();
 	...
 	//下载模板
 	function downExcel(){
 		f.action = "com.bos.grt.grtImportExcel.ImportRealestate.flow?_eosFlowAction=downExcel";
	 	f.submit();
 	}
 	//下载行政区域编码
 	function down(){
 		f.action = "com.bos.grt.grtImportExcel.ImportRealestate.flow?_eosFlowAction=down";
	 	f.submit();
 	}
  /*
  * 功能：导入表内
 ...
 function empImport(){
  	...
  	f.action = "com.bos.grt.grtImportExcel.ImportRealestate.flow?_eosFlowAction=importFile";
  	f.submit();
 }
