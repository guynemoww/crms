...
<script type="text/javascript">
	...
	$.ajax({
            ...
            success: function (text) {
            	...
            	party = text.party;
            	document.getElementById("exportFrame2").src=nui.context+"/aft/aft_small_inspect/aft_link_info_url.jsp?party="+nui.encode(party)+"&bizId="+bizId+"&corpType=2";
	...
	var menudata = [
		{id:"大众检查报告审核", text:"大中检查报告审核", //expanded:true, 
		    ...
		    {id:"检查报告",text:"检查报告",url:"/aft/dailyInspect/newCheckReport.jsp?bizId="+bizId+"&partyId="+partyId}
		...
		{id:"相关文档",text:"相关文档",
			children:[ 
					...
					{id:"影像扫描",text:"影像扫描",url:"/pub/imagePlatform/item_tree.jsp?csmNum="+party.partyNum+"&loanOverId="+bizId+"&partyTypeCd="+party.partyTypeCd+"&image=loanover"},
					{id:"文档管理",text:"文档管理",url:"/aft/file/relevantFile.jsp?applyId="+bizId+"&button=1&corpType=2"},
					{id:"贷后检查报告历史记录",text:"贷后检查报告历史记录",url:"/aft/postMgr/aft_corpCheckInfo_history.jsp?partyId="+partyId}
			]}
