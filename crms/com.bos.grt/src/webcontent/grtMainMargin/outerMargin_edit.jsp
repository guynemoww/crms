	...
	<div title="押品概况信息" id="basicTab" name="basicTab" style="width:90%;height:550px">   <!-- tabs start -->
		<div id="form1" style="width:100%;height:auto;overflow:hidden;">
			...
			<div id="panel1"  class="nui-dynpanel" columns="4">
				...
				<label>抵质押人名称：</label>
				<input name="tbGrtGuarantybasic.partyName" id="partyName" required="true" class="nui-buttonEdit nui-form-input" onbuttonclick="chooiseParty" vtype="maxLength:300" enabled="false" allowinput="false"/>
				...
				<input name="tbGrtGuarantybasic.createTime" id="tbGrtGuarantybasic.createTime" required="false" enabled="false" 
					class="nui-datepicker nui-form-input" format="yyyy-MM-dd"   vtype="maxLength:10" />
...
<script type="text/javascript">
		...
		if ("<%=request.getParameter("view")%>"!="null" && "<%=request.getParameter("view")%>"=="1") {
			        	...
			        	$.ajax({
				    		...
				    		cache: false,
				   		    ...
				   		    success: function (text) {
				    			...
				    			var suretyId = "<%=request.getParameter("suretyId") %>"
				    			typeUrl = typeUrl+"?suretyId="+suretyId +"&sortType=" + sortType+"&view=1";
