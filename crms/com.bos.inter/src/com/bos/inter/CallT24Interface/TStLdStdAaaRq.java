...
public class TStLdStdAaaRq extends SuperBosfxRq{
	...
	public String toString() {
		return "TStLdStdAaaRq [FtTxnType=" + FtTxnType + ", FBID="
				...
				+ FowWardBackward + ", BaseDateKey=" + BaseDateKey + ",TStLdRpmAaaRec=" + TStLdRpmAaaRec + "]";
    }
    /**
