...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<label>流程id(主键)：</label>
		<input name="item.processMappingId" value="<%=request.getParameter("processMappingId") %>" required="false" enabled="false" class="nui-textbox nui-form-input" vtype="maxLength:32" />
...
function save() {
	...
	$.ajax({
        url: "com.bos.bps.util.TbWfmProcessMapping.addTbWfmProcessMapping.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
