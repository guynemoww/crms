...
<body>
		...
		<div title="自然人客户查询">
			<center>
				<div id="form1" class="nui-form" style="width: 99.5%; height: auto; overflow: hidden;">
					<input name="sqlName" class="nui-hidden nui-form-input" value="com.bos.account.csm.natural" />
					<div class="nui-dynpanel" columns="8">
						<label class="nui-form-label">机构名称：</label>
						<input id="item.orgId" name="item.orgId" value="<%=GitUtil.getCurrentOrgId()%>" dictTypeId="org" allowInput="false" required="true" class="nui-buttonEdit" onbuttonclick="selectOrg" />
						<label>客户名称：</label>
						...
						<label>中征码：</label>
						<input id="item.middelCode" name="item.middelCode" required="false" class="nui-textbox nui-form-input" vtype="" />
						<label>是否农户：</label>
				...
				<div id="datagrid1" class="nui-datagrid" style="width: 99.5%; height: auto" url="com.bos.csm.pub.ibatis.getItem.biz.ext" dataField="items" allowResize="true" showReloadButton="false" sizeList="[10,15,20,50,100]" multiSelect="false" pageSize="10" onselectionchanged="" sortMode="client" allowAlternating="true">
					<div property="columns">
						...
						<div field="orgname" allowSort="true" width="" headerAlign="center" autoEscape="false">机构名称</div>
						<div field="partyName" allowSort="true" width="" headerAlign="center" dictTypeId="product">客户名称</div>
						...
						<div field="generalAdjustRatingCd" allowSort="true" width="" headerAlign="center" dictTypeId="">信用等级</div>
						<div field="userNum" allowSort="true" width="" headerAlign="center" dictTypeId="user">管户经理</div>
					</div>
				</div>
			</center>
		</div>
	...
	<script type="text/javascript">
		...
		function dc() {
			...
			$.ajax({
				url : "com.bos.csm.pub.ibatis.downloadEXCEL.biz.ext",
				type : 'POST',
				data : json,
				cache : false,
				contentType : 'text/json',
