...
<div id="panel1" class="nui-panel" title="信用保险"
	...
	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;"  sortMode="client"
		...
		<div property="columns">
	        ...
	        <div field="insuranceCompanyName" allowSort="true"  width="" headerAlign="center">信用保险名称</div>
	        <div field="insuranceCoverage" allowSort="true" width="" headerAlign="center">信用保险类型</div>
	        <div field="insurancePolicyNum" allowSort="true" width="" headerAlign="center" >保险单编号</div>
	        <div field="availableAmt" allowSort="true" width="" headerAlign="center" dataType="currency">可用金额</div>       
	        <div field="outstandingAmt" allowSort="true" width="" headerAlign="center" dataType="currency">已用金额</div>   
	        <div field="debtAmount" allowSort="true" width="" headerAlign="center" dataType="currency">本次占用价值</div>
	     </div>
	</div>
...
<script type="text/javascript">
    ...
    function search() {
		...
		var data = form.getData(); //获取表单多个控件的数据
         grid.load({"item":{"applyId":"<%=request.getParameter("bizId") %>","_entity":"com.bos.dataset.biz.TbBizGrtRelation","reType":"03"}});
    }
    search();
		nui.get("add").hide();
	  	nui.get("edit").hide();
	...
	function add(){
		nui.open({
            url: nui.context + '/biz/biz_grt/biz_creditInsurance_add.jsp?bizId=<%=request.getParameter("bizId")%>',
            showMaxButton: true,
            title: "添加关联关系",
            width: 950,
            height: 700,
	...
	function edit(v) {
        ...
        if (row) {
            nui.open({
                url: nui.context + "/biz/biz_grt/biz_creditInsurance_view.jsp?&relationId="+row.relationId+"&type=<%=request.getParameter("type") %>",
                title: "编辑", 
                width: 800,
        		height: 700,
                allowResize:true,
