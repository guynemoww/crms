...
<div id="form" style="width:99.5%;height:auto;overflow:hidden; text-align:center;"  class="nui-form">
	...
	<div id="grid" class="nui-datagrid" style="width:100%;height:auto" 
		...
		<div property="columns">
			...
			<div field="APPEND_FLAG" headerAlign="center" allowSort="true" dictTypeId="XD_0002">追加标志</div>
			<div field="APPEND_AMT" headerAlign="center" allowSort="true" >追加金额</div>
			<div field="BEGIN_DATE" headerAlign="center" allowSort="true" >起始日期</div>
	...
	function edit(v){
		...
		if (null == row) {
			...
			return false;
        	   ...
        	   nui.open({
			    	url: nui.context + "/crt/con_grt/con_bzj_add.jsp?contractId="+contractId+"&partyId="+partyId+"&applyId="+applyId+"&subcontractId="+subcontractId+"&suretyId="+row.SURETY_ID+"&view="+v+"&xgbz="+xgbz,
					title: "保证金关联信息", 
					width: 800, 
					height: 400,
					allowResize:false,
