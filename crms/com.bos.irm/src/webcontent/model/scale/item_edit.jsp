...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%--   --%><input type="hidden" name="tbIrmModelScale" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"tbIrmModelScale":
		{"modelScaleId":
		"<%=request.getParameter("modelScaleId") %>"}});
	$.ajax({
        url: "com.bos.irm.model.getTbIrmModelScale.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.model.updateTbIrmModelScale.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
