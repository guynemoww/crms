...
style="width: 100%; height: auto;">
		<div title="档案借用">
				<div id="form1" class="nui-form"
					...
					<input name="sqlName" class="nui-hidden nui-form-input" value="com.bos.rec.rec.recBaseListInstore" />
				...
				<div class="nui-toolbar"
						...
						<a class="nui-button" iconCls="icon-add" onclick="insert()">借用</a>
					</div>
				<div id="datagrid1" class="nui-datagrid"
					...
					<div property="columns">
						...
						<div field="receivePerson" allowSort="true" headerAlign="center" >接收人</div>
						<div field="orgname" allowSort="true"  headerAlign="center" dictTypeId="">出入库时间</div>
	...
	<script type="text/javascript">
		...
		function insert() {
			...
			nui.open({
				url : nui.context + '/rec/borrow/rec_base_borrow.jsp',
				showMaxButton : true,
				title : "档案借用",
				width : 400,
				height : 400,
