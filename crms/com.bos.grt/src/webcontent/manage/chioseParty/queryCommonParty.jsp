...
<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;"  sortMode="client"
	    url="com.bos.grt.grtMainMargin.grtPublic.queryCommonParty.biz.ext" dataField="items"
	    ...
	    <div property="columns">
	        ...
	        <div field="unifySocietyCreditNum" allowSort="true" width="" headerAlign="center" >统一社会信用代码</div> 
	        <div field="registrCd" allowSort="true" width="" headerAlign="center" >营业执照</div> 
	        <div field="orgRegisterCd" allowSort="true" width="" headerAlign="center" >组织机构代码</div> 
...
<script type="text/javascript">
    ...
    //query();
	//nui.get("item.partyTypeCd").setValue("02");
    ...
    function query(){
       ...
       grid.load ( o, function (text) {
	    	...
	    	nui.get("item.registrCd").setValue("");
