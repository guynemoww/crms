	...
	<fieldset>
		...
		<div id="grid1" class="nui-datagrid" sortMode="client"
		    ...
		    <div property="columns">           
				...
				<div field="CONTRACT_AMT" headerAlign="center" align="right" dataType="currency">合同金额（元）</div>
				<div field="CON_YU_E" headerAlign="center" align="right" dataType="currency">合同已用金额（元）</div>
				<div field="CONTRACT_TERM" headerAlign="center" align="center">合同期限</div>
				<div field="CYCLE_UNIT" headerAlign="center" align="center" dictTypeId="XD_GGCD6009">期限单位</div>
