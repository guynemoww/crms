...
<form id="form1" action="" method="post" class="nui-form" style="height:auto;overflow:hidden;">
	...
	<div id="grid1" class="nui-datagrid" style="width:99.65%;height:auto;margin-top:1px"
		url="com.bos.grt.marnmanage.marnmanage.tbGrtAgainprompt.biz.ext"
		dataField="prompt"
		...
		<div property="columns">
			...
			<div field="loanActualPaymentDate" headerAlign="center" allowSort="true">贷款发放日期</div>
			...
			<div field="againEndDate" headerAlign="center" allowSort="true">重估到期日期</div>
