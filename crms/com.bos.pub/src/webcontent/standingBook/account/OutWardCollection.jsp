...
<center>
 <form id="form1" action="" method="post" enctype="multipart/form-data" >
	<div class="nui-dynpanel" columns="6">
			...
			<!-- 
			<label>业务品种：</label>
			<input name="map/productType" allowInput="false" required="false" id="laidend" class="nui-buttonEdit" vtype="maxLength:32" onbuttonclick="selectProduct"/>
			 -->
			<label>放款申请编号：</label>
			...
			<label>放款到期日：</label>
			<div>
			<input name="map/expirationDate1" id="removestart" required="false" value="" class="nui-datepicker nui-form-input" onvaluechanged="onregDueDate1"/>~
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.standingbook.entrustedloan.GetOutWardCollectList.biz.ext"
	dataField="items"
	...
	<div property="columns" >
		...
		<div field="startDate" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd">放款起始日</div>
		<div field="expirationDate" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd">放款到期日</div>		
		<div field="yearRate" headerAlign="center" allowSort="true" dataType="currency">生效利率</div>
    ...
    function exportEmp()
    {
		...
		if(rows != null && rows.length > 0) {
	     var form = document.getElementById("form1");
			     form.action = "com.bos.pub.standingbook.accountManager.flow?_eosFlowAction=exportFile&importCd=216";
			     form.submit();
	    }
	    else{
	    nui.alert("没有要导出的记录");
