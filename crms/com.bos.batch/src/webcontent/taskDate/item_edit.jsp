...
<input type="hidden" name="tbBatchTaskDate" class="nui-hidden" />
	<div class="nui-dynpanel" columns="2">
		<label>批量日期：</label>
		 <input name="tbBatchTaskDate.batchDate" required="true" class="nui-datepicker nui-form-input" vtype="maxLength:2"
				id="tbGrtFund.createTime" format="yyyy-MM-dd" enabled="true" style="width:150px"/>			
	</div>
...
function initForm() {
	...
	$.ajax({
        url: "com.bos.batch.editTaskDate.getTbBatchTaskDate.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.batch.editTaskDate.updateTbBatchTaskDate.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
