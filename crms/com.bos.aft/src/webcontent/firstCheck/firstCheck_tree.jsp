...
<script type="text/javascript">
    ...
    if(qote=="1"){
	    ...
	    menudata = [
			{id:"首次检查信息", text:"首次检查信息",
				children:[
					{id:"检查信息",text:"检查信息",url:"/aft/firstCheck/firstCheck_apply.jsp?firstCheckId="+firstCheckId+"&proFlag="+proFlag}
				]
			},
	...
	//意见提交
	if("-1"!=proFlag){
		menudata[menudata.length]={id:"意见",text:"意见",url:"/com.bos.bps.service.workFlowAdvice.flow?bizId=<%=request.getParameter("firstCheckId") %>&processInstId=<%=request.getParameter("processInstId")%>&isSrc=2"};
	} 
	...
	function checkBeforeSub(){
		var json = {"firstCheckId":firstCheckId};
