...
<div id="form" style="width:99.5%;height:auto;overflow:hidden; text-align:center;"  class="nui-form">
	<div class="nui-toolbar" style="border-bottom:0;text-align:left;">
		<a class="nui-button" iconCls="icon-save" onclick="insert()" id="linkBtn">关联</a>
	...
	<div id="grid" class="nui-datagrid" style="width:100%;height:auto" 
		url="com.bos.grt.conGrt.getConSub.biz.ext"allowAlternating="true"
		...
		<div property="columns">
			...
			<div field="SURETY_NO" headerAlign="center" allowSort="true" >抵押物编号</div>
			<div field="SORT_TYPE" allowSort="true"  headerAlign="center"  dictTypeId="XD_YPZL01">抵押物类型</div>
			...
			<div field="SURETY_AMT" headerAlign="center" allowSort="true"dataType="currency">担保确认金额（元）</div>
		</div>
	</div>
</div>
	...
	function view(){
        ...
        if (row) {
        	...
        	<%--nui.open({        		
	            ...
	            url: "http://115.114.113.215:8080/default/com.bob.bcms.collateralmgr.ViewCollFlowForCredit.flow?creditFlag=1&cltNo=2017051000000001&sceneCode=1&userId="+<%=((UserObject)session.getAttribute("userObject")).getUserId()%>,
	            showMaxButton: true,
	            title:"押品信息",
	            width: 800,
	            height: 500,
