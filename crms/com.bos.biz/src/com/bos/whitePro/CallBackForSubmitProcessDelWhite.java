 ...
 * 
 * */
public class CallBackForSubmitProcessDelWhite implements IBIZProcess {

	public static TraceLogger logger = new TraceLogger(CallBackForSubmitProcessDelWhite.class);
