...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<input type="hidden" name="item._entity" value="com.bos.dataset.sys.TbSysWarnNetCreBalance" class="nui-hidden" />
	<h3>关联关系网授信余额预警参数</h3>
...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.TbSysWarnNetCreBalance.getItemList.biz.ext" dataField="items"
	allowResize="true" showReloadButton="false"
	sizeList="[10,15,20,50,100]" multiSelect="false" pageSize="15" sortMode="client">
	<div property="columns">
		<div type="checkcolumn" >选择</div>
		<div field="balanceWarnLimit" headerAlign="center" allowSort="true" >授信余额预警阀值（元）</div>
		<div field="orgId" headerAlign="center" allowSort="true" >机构编码</div>
		<div field="relNetCusCount" headerAlign="center" allowSort="true" >关联关系网客户数量</div>
    ...
    function add() {
        nui.open({
            url: "pub/warnNetCreBalance/item_add.jsp",
            title: "新增", 
            width: 800, 
        	height: 500,
        	allowResize:true,
    ...
    function edit(v) {
        ...
        if (row) {
            nui.open({
                url: "pub/warnNetCreBalance/item_edit.jsp?itemId="+row.netRelCreditBalanceId+"&view="+v,
                title: "编辑", 
                width: 800,
        		height: 500,
                allowResize:true,
    ...
    function remove() {
        ...
        if (row) {
        	nui.confirm("确定删除吗？","确认",function(action){
            	if(action!="ok") return;
            	var json=nui.encode({"item":{"netRelCreditBalanceId":
            		row.netRelCreditBalanceId,
					"_entity":"com.bos.dataset.sys.TbSysWarnNetCreBalance"}});
                $.ajax({
                     url: "com.bos.pub.TbSysWarnNetCreBalance.delItem.biz.ext",
	                type: 'POST',
	                data: json,
	                cache: false,
