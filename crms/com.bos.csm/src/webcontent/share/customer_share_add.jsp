...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	...
	<div class="nui-dynpanel" columns="4">
		...
		<label>共享原因：</label>
		<input id="transPerson" name="transPerson" required="true" class="nui-dictcombobox nui-form-input" dictTypeId="XD_KHCD322830"/>
		<label>经办人：</label>
		<input name="oldUserNum" required="true" value="<%=((UserObject)session.getAttribute("userObject")).getUserName() %>"   class="nui-textbox nui-form-input" Enabled="false" />
	</div>
</div>
...
<script type="text/javascript">
	...
	function save(){
        ...
        nui.confirm("确定共享这些客户吗？", "确认", function(action) {
			if (action != "ok"){
				return;
		}
        GetData();
