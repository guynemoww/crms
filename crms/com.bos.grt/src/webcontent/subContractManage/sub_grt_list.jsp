...
<div id="form" style="width:99.5%;height:auto;overflow:hidden; text-align:center;"  class="nui-form">
	...
	<div id="grid" class="nui-datagrid" style="width:100%;height:auto" 
		url="com.bos.grt.conGrt.selSubGrt.biz.ext"
		...
		<div property="columns">
			...
			<div field="MORTGAGE_VALUE" headerAlign="center" allowSort="true"dataType="currency"  >权利价值</div>
			<div field="SURETY_AMT" headerAlign="center" allowSort="true" dataType="currency" >已担保金额</div>
		</div>
	</div>
</div>
