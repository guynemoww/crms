...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
		...
		<label>省/直辖：</label>
		<input id="item.provinceCd" name="item.provinceCd" required="false" class="nui-combobox nui-form-input" onvaluechanged="d1Change" valueField="dictid" textField="dictname"  />

		<label>市：</label>
		<input  id="item.cityCd" name="item.cityCd" required="false"class="nui-combobox nui-form-input"  onvaluechanged="d2Change" valueField="dictid" textField="dictname"  />

		<label>区县：</label>
		<input id="item.district"  name="item.district" required="false" class="nui-combobox nui-form-input" valueField="dictid" textField="dictname"  />
		</div>
</div>
