...
<div class="nui-toolbar" style="border-bottom:0;">
	<a class="nui-button" iconCls="icon-add" onclick="add()">申辩申请</a>
</div>
	    
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	url="com.bos.pub.openOrder.checkOrderMessage.biz.ext"
    ...
    function add() {
        ...
        if (row) {
        	nui.open({
            url: "pub/openOrder/defend/item_add.jsp?scoreMessageId="+row.scoreMessageId,
            title: "申辩申请", 
            width: 800, 
        	height: 500,
        	allowResize:true,
