...
<div id="grid1" class="nui-datagrid" style="width:100%;height:auto" 
	...
	<div property="columns">
		...
		<div field="indexScore" headerAlign="center" allowSort="true" required="true" vtype="range:0,100">档位分值
			<input property="editor"  class="nui-textbox"   style="width:100%;"  />
		</div>
		<div field="indexCalcLogic" headerAlign="center" allowSort="true" required="true" vtype ="negative">档位计算逻辑
			<input property="editor"  class="nui-textbox"   style="width:100%;"  />
		</div>
...
<div align='left' class='description' style='color:red;'><h4>*录入异常档位时档位选项为:大写Z,档位计算逻辑为:01、02、03、04、05,档位得分为该异常情况得分</h4></div>
