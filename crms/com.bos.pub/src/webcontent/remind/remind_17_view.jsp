...
<div id="grid1" class="nui-datagrid" style="width:99.5%;height:auto;" sortMode="client"
	...
	<div property="columns">
		...
		<div field="WARRANT_NAME" headerAlign="center"  allowSort="true"  dictTypeId="XD_SXFS0002" >权证名称</div>
		<div field="WARRANT_NO" headerAlign="center"  allowSort="true"  >权证编号</div>
		<div field="CONTRACT_NUM" headerAlign="center" allowSort="true" >借款合同编号</div>
		...
		<div field="WARRANT_END_DT" headerAlign="center"  allowSort="true"  dateFormat="yyyy-MM-dd" >权证登记失效日期</div>
		<div field="OPR_ORG_NAME" headerAlign="center"  allowSort="true" >经办机构</div>
		<div field="OPR_USER_NAME" headerAlign="center"  allowSort="true">经办人</div>
		<div field="WARN_CREATE_DT" headerAlign="center"  allowSort="true"  dateFormat="yyyy-MM-dd">预警提示生成日期</div>
...
<script type="text/javascript">
	...
	function toDo(){
		    ...
		    if(row){
			    ...
			    var warrantNo = row.WARRANT_NO;
				var url = "http://"+"<%=ipStr%>"+":"+"<%=portStr%>"+"/default/com.bob.bcms.collateralmgr.warrants.BCiwarrantsMaintainForWarn.flow?creditFlag=1&warrantNo="+warrantNo+"&cltNo="+cltNo+"&orgId=<%=((UserObject)session.getAttribute("userObject")).getUserOrgId()%>&userId=<%=((UserObject)session.getAttribute("userObject")).getUserId()%>";
				window.open(url);
				return;
		    }
	}
