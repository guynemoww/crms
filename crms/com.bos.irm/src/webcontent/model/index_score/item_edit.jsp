...
<div id="form1" style="width:100%;height:auto;overflow:hidden;">
	<%--   --%><input type="hidden" name="tbIrmIndexScore" class="nui-hidden" />
...
function initForm() {
	var json=nui.encode({"tbIrmIndexScore":
		{"scoreId":
		"<%=request.getParameter("scoreId") %>"}});
	$.ajax({
        url: "com.bos.irm.model.getTbIrmIndexScore.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
...
function save() {
	...
	$.ajax({
        url: "com.bos.irm.model.updateTbIrmIndexScore.biz.ext",
        type: 'POST',
        data: json,
        cache: false,
        contentType:'text/json',
